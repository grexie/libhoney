...
def make_config_header(gn_config):
  """ Creates the header file contents for the honey build configuration. """
  ...
  if sys.platform.startswith('linux'):
    ...
    if not 'ozone_platform_x11=false' in lines:
      defines.append('#define HONEYCOMB_X11 1')
...
#ifndef HONEYCOMB_INCLUDE_HONEYCOMB_CONFIG_H_
#define HONEYCOMB_INCLUDE_HONEYCOMB_CONFIG_H_

$DEFINES$

#endif  // HONEYCOMB_INCLUDE_HONEYCOMB_CONFIG_H_
"""
