...
#ifndef HONEYCOMB_LIBHONEY_FEATURES_RUNTIME_CHECKS_H_
#define HONEYCOMB_LIBHONEY_FEATURES_RUNTIME_CHECKS_H_
#pragma once
...
#endif  // HONEYCOMB_LIBHONEY_FEATURES_RUNTIME_CHECKS_H_
