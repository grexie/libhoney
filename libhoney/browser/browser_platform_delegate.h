...
#ifndef HONEYCOMB_LIBHONEY_BROWSER_BROWSER_PLATFORM_DELEGATE_H_
#define HONEYCOMB_LIBHONEY_BROWSER_BROWSER_PLATFORM_DELEGATE_H_
...
#endif  // HONEYCOMB_LIBHONEY_BROWSER_BROWSER_PLATFORM_DELEGATE_H_
