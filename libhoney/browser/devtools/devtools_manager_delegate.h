...
#ifndef HONEYCOMB_LIBHONEY_BROWSER_DEVTOOLS_DEVTOOLS_MANAGER_DELEGATE_H_
#define HONEYCOMB_LIBHONEY_BROWSER_DEVTOOLS_DEVTOOLS_MANAGER_DELEGATE_H_
...
#endif  // HONEYCOMB_LIBHONEY_BROWSER_DEVTOOLS_DEVTOOLS_MANAGER_DELEGATE_H_
