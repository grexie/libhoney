...
#include "libhoney/browser/extensions/value_store/honey_value_store_factory.h"
...
void HoneycombExtensionSystem::Init() {
  ...
  // 1. The PDF plugin is registered in libhoney/common/content_client.cc
  ...
  //      libhoney/common/extensions/api/README.txt.
