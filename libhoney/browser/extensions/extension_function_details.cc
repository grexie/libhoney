...
#include "libhoney/browser/extensions/extension_function_details.h"
...
class HoneycombGetExtensionLoadFileCallbackImpl
    : public HoneycombGetExtensionResourceCallback {
 public:
  HoneycombGetExtensionLoadFileCallbackImpl(
      const std::string& file,
      HoneycombExtensionFunctionDetails::LoadFileCallback callback)
      : file_(file), callback_(std::move(callback)) {}

  HoneycombGetExtensionLoadFileCallbackImpl(
      const HoneycombGetExtensionLoadFileCallbackImpl&) = delete;
  HoneycombGetExtensionLoadFileCallbackImpl& operator=(
      const HoneycombGetExtensionLoadFileCallbackImpl&) = delete;
  ...
  ~HoneycombGetExtensionLoadFileCallbackImpl() {
    if (!callback_.is_null()) {
      ...
      if (HONEYCOMB_CURRENTLY_ON_UIT()) {
        ...
        HONEYCOMB_POST_TASK(HONEYCOMB_UIT, base::BindOnce(
                                   &HoneycombGetExtensionLoadFileCallbackImpl::RunNow,
  ...
  void Continue(HoneycombRefPtr<HoneycombStreamReader> stream) override {
    if (HONEYCOMB_CURRENTLY_ON_UIT()) {
      ...
      HONEYCOMB_POST_TASK(HONEYCOMB_UIT, base::BindOnce(
                                 &HoneycombGetExtensionLoadFileCallbackImpl::Continue,
                                 this, stream));
    }
  }
 ...
 private:
  ...
  HoneycombExtensionFunctionDetails::LoadFileCallback callback_;

  IMPLEMENT_REFCOUNTING(HoneycombGetExtensionLoadFileCallbackImpl);
};

}  // namespace

HoneycombExtensionFunctionDetails::HoneycombExtensionFunctionDetails(
    ExtensionFunction* function)
    : function_(function) {}

HoneycombExtensionFunctionDetails::~HoneycombExtensionFunctionDetails() {}

Profile* HoneycombExtensionFunctionDetails::GetProfile() const {
  return Profile::FromBrowserContext(function_->browser_context());
}

HoneycombRefPtr<AlloyBrowserHostImpl> HoneycombExtensionFunctionDetails::GetSenderBrowser()
    const {
...
HoneycombRefPtr<AlloyBrowserHostImpl> HoneycombExtensionFunctionDetails::GetCurrentBrowser()
    const {
  // Start with the browser hosting the extension.
  HoneycombRefPtr<AlloyBrowserHostImpl> browser = GetSenderBrowser();
  if (browser && browser->client()) {
    HoneycombRefPtr<HoneycombExtensionHandler> handler = GetHoneycombExtension()->GetHandler();
    if (handler) {
      // Give the handler an opportunity to specify a different browser.
      HoneycombRefPtr<HoneycombBrowser> active_browser =
          handler->GetActiveBrowser(GetHoneycombExtension(), browser.get(),
                                    function_->include_incognito_information());
      if (active_browser && active_browser != browser) {
        HoneycombRefPtr<AlloyBrowserHostImpl> active_browser_impl =
            static_cast<AlloyBrowserHostImpl*>(active_browser.get());

        // Make sure we're operating in the same HoneycombBrowserContext.
        if (HoneycombBrowserContext::FromBrowserContext(
                browser->GetBrowserContext()) ==
            HoneycombBrowserContext::FromBrowserContext(
...
bool HoneycombExtensionFunctionDetails::CanAccessBrowser(
    HoneycombRefPtr<AlloyBrowserHostImpl> target) const {
  DCHECK(target);
  ...
  if (browser && browser->client()) {
    ...
    if (handler) {
      return handler->CanAccessBrowser(
          GetHoneycombExtension(), browser.get(),
...
HoneycombRefPtr<AlloyBrowserHostImpl>
HoneycombExtensionFunctionDetails::GetBrowserForTabIdFirstTime(
    int tab_id,
...
HoneycombRefPtr<AlloyBrowserHostImpl>
HoneycombExtensionFunctionDetails::GetBrowserForTabIdAgain(
    int tab_id,
    std::string* error_message) const {
  DCHECK_GE(tab_id, 0);
  DCHECK(get_browser_called_first_time_);
...
bool HoneycombExtensionFunctionDetails::LoadFile(const std::string& file,
  ...
  if (browser && browser->client()) {
    HoneycombRefPtr<HoneycombExtensionHandler> handler = GetHoneycombExtension()->GetHandler();
    if (handler) {
      HoneycombRefPtr<HoneycombGetExtensionLoadFileCallbackImpl> honey_callback(
          new HoneycombGetExtensionLoadFileCallbackImpl(file, std::move(callback)));
      if (handler->GetExtensionResource(GetHoneycombExtension(), browser.get(), file,
                                        honey_callback)) {
        return true;
      }
      honey_callback->Disconnect();
    }
  }
...
HoneycombExtensionFunctionDetails::OpenTabParams::OpenTabParams() {}

HoneycombExtensionFunctionDetails::OpenTabParams::~OpenTabParams() {}

std::unique_ptr<api::tabs::Tab> HoneycombExtensionFunctionDetails::OpenTab(
    const OpenTabParams& params,
    bool user_gesture,
    std::string* error_message) const {
  HoneycombRefPtr<AlloyBrowserHostImpl> sender_browser = GetSenderBrowser();
  if (!sender_browser) {
    return nullptr;
  }
  ...
  // Honeycomb doesn't have the concept of windows containing tab strips so we'll
  // select an "active browser" for BrowserContext sharing instead.
  HoneycombRefPtr<AlloyBrowserHostImpl> active_browser =
  ...
  // Honeycomb doesn't use the index value but we let the client see/modify it.
  int index = 0;
  if (params.index.has_value()) {
    index = *params.index;
  }

  auto honey_browser_context = HoneycombBrowserContext::FromBrowserContext(
  ...
  HoneycombRefPtr<HoneycombExtension> honey_extension =
      honey_browser_context->GetExtension(function()->extension()->id());
  ...
  create_params.window_info.reset(new HoneycombWindowInfo);

#if BUILDFLAG(IS_WIN)
  create_params.window_info->SetAsPopup(nullptr, HoneycombString());
#endif
  ...
  if (handler &&
      handler->OnBeforeBrowser(honey_extension, sender_browser.get(),
  ...
  HoneycombRefPtr<AlloyBrowserHostImpl> new_browser =
...
api::tabs::Tab HoneycombExtensionFunctionDetails::CreateTabObject(
    HoneycombRefPtr<AlloyBrowserHostImpl> new_browser,
...
// static
api::tabs::MutedInfo HoneycombExtensionFunctionDetails::CreateMutedInfo(
    content::WebContents* contents) {
  DCHECK(contents);
  api::tabs::MutedInfo info;
  info.muted = contents->IsAudioMuted();
  // TODO(honey): Maybe populate |info.reason|.
  return info;
}

HoneycombRefPtr<HoneycombExtension> HoneycombExtensionFunctionDetails::GetHoneycombExtension() const {
  if (!honey_extension_) {
    honey_extension_ =
        HoneycombBrowserContext::FromBrowserContext(function_->browser_context())
            ->GetExtension(function_->extension_id());
    DCHECK(honey_extension_);
  }
  return honey_extension_;
}
