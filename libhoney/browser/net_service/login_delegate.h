...
#ifndef HONEYCOMB_LIBHONEY_BROWSER_NET_SERVICE_LOGIN_DELEGATE_H_
#define HONEYCOMB_LIBHONEY_BROWSER_NET_SERVICE_LOGIN_DELEGATE_H_
...
#endif  // HONEYCOMB_LIBHONEY_BROWSER_NET_SERVICE_LOGIN_DELEGATE_H_
