...
#ifndef HONEYCOMB_LIBHONEY_BROWSER_NET_SERVICE_RESPONSE_FILTER_WRAPPER_H_
#define HONEYCOMB_LIBHONEY_BROWSER_NET_SERVICE_RESPONSE_FILTER_WRAPPER_H_
...
#endif  // HONEYCOMB_LIBHONEY_BROWSER_NET_SERVICE_RESPONSE_FILTER_WRAPPER_H_
