...
#ifndef HONEYCOMB_LIBHONEY_BROWSER_NET_SERVICE_COOKIE_HELPER_H_
#define HONEYCOMB_LIBHONEY_BROWSER_NET_SERVICE_COOKIE_HELPER_H_
...
#endif  // HONEYCOMB_LIBHONEY_BROWSER_NET_SERVICE_COOKIE_HELPER_H_
