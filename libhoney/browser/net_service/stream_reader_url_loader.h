...
#ifndef HONEYCOMB_LIBHONEY_BROWSER_NET_SERVICE_STREAM_READER_URL_LOADER_H_
#define HONEYCOMB_LIBHONEY_BROWSER_NET_SERVICE_STREAM_READER_URL_LOADER_H_
...
#endif  // HONEYCOMB_LIBHONEY_BROWSER_NET_SERVICE_STREAM_READER_URL_LOADER_H_
