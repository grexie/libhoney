...
// Request ID for requests initiated by HoneycombBrowserURLRequest. request_ids
...
class RequestManager {
 public:
  ...
  void Add(int32_t request_id,
           HoneycombRefPtr<HoneycombBrowserURLRequest> request,
  ...
  absl::optional<HoneycombBrowserURLRequest::RequestInfo> Get(int32_t request_id) {
    if (request_id > kInitialRequestID) {
      return absl::nullopt;
    }
 ...
 private:
  ...
  using RequestMap = std::map<int32_t, HoneycombBrowserURLRequest::RequestInfo>;
  RequestMap map_;
};
...
// HoneycombBrowserURLRequest::Context ----------------------------------------------

class HoneycombBrowserURLRequest::Context
    : public network::SimpleURLLoaderStreamConsumer {
 public:
  Context(HoneycombRefPtr<HoneycombBrowserURLRequest> url_request,
      ...
      : url_request_(url_request),
        frame_(frame),
        request_(static_cast<HoneycombRequestImpl*>(request.get())),
        client_(client),
        request_context_(request_context),
        task_runner_(HoneycombTaskRunnerImpl::GetCurrentTaskRunner()),
        response_(new HoneycombResponseImpl()),
  ...
  bool Start() {
    ...
    auto request_context_impl =
        static_cast<HoneycombRequestContextImpl*>(request_context_.get());
    ...
    request_context_impl->ExecuteWhenBrowserContextInitialized(base::BindOnce(
        &HoneycombBrowserURLRequest::Context::GetURLLoaderFactoryGetterOnUIThread,
  ...
  HoneycombRefPtr<HoneycombRequest> request() const { return request_.get(); }
  HoneycombRefPtr<HoneycombURLRequestClient> client() const { return client_; }
  HoneycombURLRequest::Status status() const { return status_; }
  HoneycombRefPtr<HoneycombResponse> response() const { return response_.get(); }
 ...
 private:
  static void GetURLLoaderFactoryGetterOnUIThread(
      HoneycombRefPtr<HoneycombFrame> frame,
      HoneycombRefPtr<HoneycombRequestContext> request_context,
      base::WeakPtr<HoneycombBrowserURLRequest::Context> self,
      scoped_refptr<base::SequencedTaskRunner> task_runner) {
    HONEYCOMB_REQUIRE_UIT();

    // Get or create the request context and browser context.
    HoneycombRefPtr<HoneycombRequestContextImpl> request_context_impl =
        HoneycombRequestContextImpl::GetOrCreateForRequestContext(request_context);
    ...
    if (frame) {
      ...
      content::RenderFrameHost* rfh =
          static_cast<HoneycombFrameHostImpl*>(frame.get())->GetRenderFrameHost();
      if (rfh) {
    ...
    task_runner->PostTask(
        FROM_HERE,
        base::BindOnce(
            &HoneycombBrowserURLRequest::Context::ContinueOnOriginatingThread, self,
  ...
  void ContinueOnOriginatingThread(
    ...
    static_cast<HoneycombRequestImpl*>(request_.get())
    ...
    if (request_flags & UR_FLAG_STOP_ON_REDIRECT) {
      ...
      loader_->SetOnRedirectCallback(
          base::BindRepeating(&HoneycombBrowserURLRequest::Context::OnRedirect,
                              weak_ptr_factory_.GetWeakPtr()));
    }

    if (request_flags & UR_FLAG_REPORT_UPLOAD_PROGRESS) {
      loader_->SetOnUploadProgressCallback(
          base::BindRepeating(&HoneycombBrowserURLRequest::Context::OnUploadProgress,
                              weak_ptr_factory_.GetWeakPtr()));
    }
    ...
    if ((request_flags & UR_FLAG_NO_DOWNLOAD_DATA) || method == "HEAD") {
      loader_->DownloadHeadersOnly(
          loader_factory.get(),
          base::BindOnce(&HoneycombBrowserURLRequest::Context::OnHeadersOnly,
                         weak_ptr_factory_.GetWeakPtr()));
    } else {
      loader_->SetOnResponseStartedCallback(
          base::BindOnce(&HoneycombBrowserURLRequest::Context::OnResponseStarted,
                         weak_ptr_factory_.GetWeakPtr()));
      loader_->SetOnDownloadProgressCallback(base::BindRepeating(
          &HoneycombBrowserURLRequest::Context::OnDownloadProgress,
          weak_ptr_factory_.GetWeakPtr()));
  ...
  void OnComplete(bool success) override {
    ...
    if (status_ == UR_IO_PENDING) {
      ...
      response_->SetError(static_cast<honey_errorcode_t>(loader_->NetError()));
      response_->SetReadOnly(true);
  ...
  HoneycombRefPtr<HoneycombBrowserURLRequest> url_request_;
  HoneycombRefPtr<HoneycombFrame> frame_;
  HoneycombRefPtr<HoneycombRequestImpl> request_;
  HoneycombRefPtr<HoneycombURLRequestClient> client_;
  ...
  HoneycombURLRequest::Status status_ = UR_IO_PENDING;
  HoneycombRefPtr<HoneycombResponseImpl> response_;
  ...
  base::WeakPtrFactory<HoneycombBrowserURLRequest::Context> weak_ptr_factory_;
};

// HoneycombBrowserURLRequest -------------------------------------------------------

// static
absl::optional<HoneycombBrowserURLRequest::RequestInfo>
HoneycombBrowserURLRequest::FromRequestID(int32_t request_id) {
...
// static
absl::optional<HoneycombBrowserURLRequest::RequestInfo>
HoneycombBrowserURLRequest::FromRequestID(
    const content::GlobalRequestID& request_id) {
  return FromRequestID(request_id.request_id);
}

HoneycombBrowserURLRequest::HoneycombBrowserURLRequest(
    HoneycombRefPtr<HoneycombFrame> frame,
    HoneycombRefPtr<HoneycombRequest> request,
    HoneycombRefPtr<HoneycombURLRequestClient> client,
    HoneycombRefPtr<HoneycombRequestContext> request_context) {
...
bool HoneycombBrowserURLRequest::Start() {
  if (!VerifyContext()) {
    return false;
  }
...
HoneycombRefPtr<HoneycombRequest> HoneycombBrowserURLRequest::GetRequest() {
  if (!VerifyContext()) {
    return nullptr;
  }
...
HoneycombRefPtr<HoneycombURLRequestClient> HoneycombBrowserURLRequest::GetClient() {
  if (!VerifyContext()) {
    return nullptr;
  }
...
HoneycombURLRequest::Status HoneycombBrowserURLRequest::GetRequestStatus() {
  if (!VerifyContext()) {
    return UR_UNKNOWN;
  }
...
HoneycombURLRequest::ErrorCode HoneycombBrowserURLRequest::GetRequestError() {
  if (!VerifyContext()) {
    return ERR_NONE;
  }
...
HoneycombRefPtr<HoneycombResponse> HoneycombBrowserURLRequest::GetResponse() {
  if (!VerifyContext()) {
    return nullptr;
  }
...
bool HoneycombBrowserURLRequest::ResponseWasCached() {
  if (!VerifyContext()) {
    return false;
  }
...
void HoneycombBrowserURLRequest::Cancel() {
  if (!VerifyContext()) {
    return;
  }
...
bool HoneycombBrowserURLRequest::VerifyContext() {
