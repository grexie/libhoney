...
#ifndef LIBHONEY_BROWSER_PRINTING_PRINT_DIALOG_LINUX_H_
#define LIBHONEY_BROWSER_PRINTING_PRINT_DIALOG_LINUX_H_
...
#endif  // LIBHONEY_BROWSER_PRINTING_PRINT_DIALOG_LINUX_H_
