...
#include "libhoney/browser/native/menu_runner_views_aura.h"
...
HoneycombMenuRunnerViewsAura::HoneycombMenuRunnerViewsAura() {}

bool HoneycombMenuRunnerViewsAura::RunContextMenu(
...
void HoneycombMenuRunnerViewsAura::CancelContextMenu() {
  if (menu_) {
    menu_->Cancel();
  }
}

bool HoneycombMenuRunnerViewsAura::FormatLabel(std::u16string& label) {
