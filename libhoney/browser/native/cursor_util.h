...
#ifndef HONEYCOMB_LIBHONEY_BROWSER_NATIVE_CURSOR_UTIL_H_
#define HONEYCOMB_LIBHONEY_BROWSER_NATIVE_CURSOR_UTIL_H_
...
#endif  // HONEYCOMB_LIBHONEY_BROWSER_NATIVE_CURSOR_UTIL_H_
