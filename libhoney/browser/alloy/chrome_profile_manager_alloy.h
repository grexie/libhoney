...
#ifndef HONEYCOMB_LIBHONEY_BROWSER_ALLOY_CHROME_PROFILE_MANAGER_ALLOY_H_
#define HONEYCOMB_LIBHONEY_BROWSER_ALLOY_CHROME_PROFILE_MANAGER_ALLOY_H_
...
#endif  // HONEYCOMB_LIBHONEY_BROWSER_ALLOY_CHROME_PROFILE_MANAGER_ALLOY_H_
