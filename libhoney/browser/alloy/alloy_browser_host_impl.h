...
#ifndef HONEYCOMB_LIBHONEY_BROWSER_ALLOY_ALLOY_BROWSER_HOST_IMPL_H_
#define HONEYCOMB_LIBHONEY_BROWSER_ALLOY_ALLOY_BROWSER_HOST_IMPL_H_
#pragma once
...
#include "libhoney/browser/javascript_dialog_manager.h"
#include "libhoney/browser/menu_manager.h"
...
class HoneycombAudioCapturer;
class HoneycombBrowserInfo;
class SiteInstance;

// HoneycombBrowser implementation for the alloy runtime. Method calls are delegated
// to the HoneycombPlatformDelegate or the WebContents as appropriate. All methods are
...
class AlloyBrowserHostImpl : public HoneycombBrowserHostBase,
                             public content::WebContentsDelegate,
                             public content::WebContentsObserver {
 public:
  // Used for handling the response to command messages.
  class CommandResponseHandler : public virtual HoneycombBaseRefCounted {
   public:
  ...
  static HoneycombRefPtr<AlloyBrowserHostImpl> Create(
      HoneycombBrowserCreateParams& create_params);

  // Returns the browser associated with the specified RenderViewHost.
  static HoneycombRefPtr<AlloyBrowserHostImpl> GetBrowserForHost(
  ...
  static HoneycombRefPtr<AlloyBrowserHostImpl> GetBrowserForContents(
      const content::WebContents* contents);
  // Returns the browser associated with the specified global ID.
  static HoneycombRefPtr<AlloyBrowserHostImpl> GetBrowserForGlobalId(
 ...
 private:
  friend class HoneycombBrowserPlatformDelegateAlloy;

  static HoneycombRefPtr<AlloyBrowserHostImpl> CreateInternal(
      const HoneycombBrowserSettings& settings,
      HoneycombRefPtr<HoneycombClient> client,
      content::WebContents* web_contents,
  ...
  std::unique_ptr<HoneycombJavaScriptDialogManager> javascript_dialog_manager_;

  // Used for creating and managing context menus.
  std::unique_ptr<HoneycombMenuManager> menu_manager_;

  // Used for capturing audio for HoneycombAudioHandler.
  std::unique_ptr<HoneycombAudioCapturer> audio_capturer_;
...
#endif  // HONEYCOMB_LIBHONEY_BROWSER_ALLOY_ALLOY_BROWSER_HOST_IMPL_H_
