...
#ifndef HONEYCOMB_LIBHONEY_BROWSER_AUDIO_LOOPBACK_STREAM_CREATOR_H_
#define HONEYCOMB_LIBHONEY_BROWSER_AUDIO_LOOPBACK_STREAM_CREATOR_H_
...
#endif  // HONEYCOMB_LIBHONEY_BROWSER_AUDIO_LOOPBACK_STREAM_CREATOR_H_
