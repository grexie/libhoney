...
#ifndef HONEYCOMB_LIBHONEY_BROWSER_VIEWS_VIEW_IMPL_H_
#define HONEYCOMB_LIBHONEY_BROWSER_VIEWS_VIEW_IMPL_H_
#pragma once
...
//    derived class.
//    * Using existing file contents as a model, make the following changes in
//      honey/libhoney/browser/views/panel_impl.h:
...
//    As*() method.
//    * Using existing file contents as a model, make the following changes in
//      honey/libhoney/browser/views/view_adapter.cc:
//      * Include "include/views/honey_foo_bar.h".
...
//      a HoneycombFooBarView class at honey/libhoney/browser/views/foo_bar_view.[cc|h].
//      This class:
...
//      HoneycombFooBarImpl class at honey/libhoney/browser/views/foo_bar_impl.[cc|h].
//      This class:
...
//       honey/libhoney/browser/views/foo_bar_impl.cc. This method:
...
//
// 11. Add the new source files from #7 and #8 to the 'libhoney_static' target in
//     honey.gyp.
//
...
#endif  // HONEYCOMB_LIBHONEY_BROWSER_VIEWS_VIEW_IMPL_H_
