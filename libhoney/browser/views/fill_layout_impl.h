...
#ifndef HONEYCOMB_LIBHONEY_BROWSER_VIEWS_FILL_LAYOUT_IMPL_H_
#define HONEYCOMB_LIBHONEY_BROWSER_VIEWS_FILL_LAYOUT_IMPL_H_
#pragma once

#include "include/views/honey_fill_layout.h"

#include "libhoney/browser/views/layout_impl.h"
...
#endif  // HONEYCOMB_LIBHONEY_BROWSER_VIEWS_FILL_LAYOUT_IMPL_H_
