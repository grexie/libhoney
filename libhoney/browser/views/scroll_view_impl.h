...
#ifndef HONEYCOMB_LIBHONEY_BROWSER_VIEWS_SCROLL_VIEW_IMPL_H_
#define HONEYCOMB_LIBHONEY_BROWSER_VIEWS_SCROLL_VIEW_IMPL_H_
#pragma once

#include "include/views/honey_scroll_view.h"
#include "include/views/honey_view_delegate.h"

#include "libhoney/browser/views/scroll_view_view.h"
