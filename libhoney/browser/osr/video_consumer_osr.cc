...
#include "libhoney/browser/osr/video_consumer_osr.h"
...
HoneycombVideoConsumerOSR::HoneycombVideoConsumerOSR(HoneycombRenderWidgetHostViewOSR* view)
...
HoneycombVideoConsumerOSR::~HoneycombVideoConsumerOSR() = default;

void HoneycombVideoConsumerOSR::SetActive(bool active) {
  if (active) {
...
void HoneycombVideoConsumerOSR::SetFrameRate(base::TimeDelta frame_rate) {
  video_capturer_->SetMinCapturePeriod(frame_rate);
}

void HoneycombVideoConsumerOSR::SizeChanged(const gfx::Size& size_in_pixels) {
...
void HoneycombVideoConsumerOSR::RequestRefreshFrame(
...
//   constraints.
void HoneycombVideoConsumerOSR::OnFrameCaptured(
