...
#ifndef HONEYCOMB_LIBHONEY_BROWSER_OSR_BROWSER_PLATFORM_DELEGATE_OSR_WIN_H_
#define HONEYCOMB_LIBHONEY_BROWSER_OSR_BROWSER_PLATFORM_DELEGATE_OSR_WIN_H_
...
#endif  // HONEYCOMB_LIBHONEY_BROWSER_NATIVE_BROWSER_PLATFORM_DELEGATE_OSR_WIN_H_
