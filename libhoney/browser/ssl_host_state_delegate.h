...
#ifndef HONEYCOMB_LIBHONEY_BROWSER_SSL_HOST_STATE_DELEGATE_H_
#define HONEYCOMB_LIBHONEY_BROWSER_SSL_HOST_STATE_DELEGATE_H_
...
#endif  // HONEYCOMB_LIBHONEY_BROWSER_SSL_HOST_STATE_DELEGATE_H_
