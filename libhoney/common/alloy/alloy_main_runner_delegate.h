...
#ifndef HONEYCOMB_LIBHONEY_COMMON_ALLOY_ALLOY_MAIN_RUNNER_DELEGATE_
#define HONEYCOMB_LIBHONEY_COMMON_ALLOY_ALLOY_MAIN_RUNNER_DELEGATE_
...
#endif  // HONEYCOMB_LIBHONEY_COMMON_ALLOY_ALLOY_MAIN_RUNNER_DELEGATE_
