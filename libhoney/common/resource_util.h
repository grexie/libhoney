...
#ifndef HONEYCOMB_LIBHONEY_COMMON_RESOURCE_UTIL_H_
#define HONEYCOMB_LIBHONEY_COMMON_RESOURCE_UTIL_H_
#pragma once
...
// libEGL.so, locales/*.pak, swiftshader/*.so) next to libhoney instead of the exe
...
#endif  // HONEYCOMB_LIBHONEY_COMMON_RESOURCE_UTIL_H_
