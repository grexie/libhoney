...
honey_cookie_same_site_t MakeHoneycombCookieSameSite(net::CookieSameSite value) {
  switch (value) {
    case net::CookieSameSite::UNSPECIFIED:
      return HONEYCOMB_COOKIE_SAME_SITE_UNSPECIFIED;
    case net::CookieSameSite::NO_RESTRICTION:
      return HONEYCOMB_COOKIE_SAME_SITE_NO_RESTRICTION;
    case net::CookieSameSite::LAX_MODE:
      return HONEYCOMB_COOKIE_SAME_SITE_LAX_MODE;
    case net::CookieSameSite::STRICT_MODE:
      return HONEYCOMB_COOKIE_SAME_SITE_STRICT_MODE;
  }
}

honey_cookie_priority_t MakeHoneycombCookiePriority(net::CookiePriority value) {
  switch (value) {
    case net::COOKIE_PRIORITY_LOW:
      return HONEYCOMB_COOKIE_PRIORITY_LOW;
    case net::COOKIE_PRIORITY_MEDIUM:
      return HONEYCOMB_COOKIE_PRIORITY_MEDIUM;
    case net::COOKIE_PRIORITY_HIGH:
      return HONEYCOMB_COOKIE_PRIORITY_HIGH;
  }
}
...
net::CookieSameSite MakeCookieSameSite(honey_cookie_same_site_t value) {
  switch (value) {
    case HONEYCOMB_COOKIE_SAME_SITE_UNSPECIFIED:
      return net::CookieSameSite::UNSPECIFIED;
    case HONEYCOMB_COOKIE_SAME_SITE_NO_RESTRICTION:
      return net::CookieSameSite::NO_RESTRICTION;
    case HONEYCOMB_COOKIE_SAME_SITE_LAX_MODE:
      return net::CookieSameSite::LAX_MODE;
    case HONEYCOMB_COOKIE_SAME_SITE_STRICT_MODE:
...
net::CookiePriority MakeCookiePriority(honey_cookie_priority_t value) {
  switch (value) {
    case HONEYCOMB_COOKIE_PRIORITY_LOW:
      return net::COOKIE_PRIORITY_LOW;
    case HONEYCOMB_COOKIE_PRIORITY_MEDIUM:
      return net::COOKIE_PRIORITY_MEDIUM;
    case HONEYCOMB_COOKIE_PRIORITY_HIGH:
      return net::COOKIE_PRIORITY_HIGH;
  }
}

bool MakeHoneycombCookie(const net::CanonicalCookie& cc, HoneycombCookie& cookie) {
  HoneycombString(&cookie.name).FromString(cc.Name());
  HoneycombString(&cookie.value).FromString(cc.Value());
  HoneycombString(&cookie.domain).FromString(cc.Domain());
  HoneycombString(&cookie.path).FromString(cc.Path());
  cookie.secure = cc.IsSecure();
  cookie.httponly = cc.IsHttpOnly();
  cookie.creation = HoneycombBaseTime(cc.CreationDate());
  cookie.last_access = HoneycombBaseTime(cc.LastAccessDate());
  cookie.has_expires = cc.IsPersistent();
  if (cookie.has_expires) {
    cookie.expires = HoneycombBaseTime(cc.ExpiryDate());
  }
  cookie.same_site = MakeHoneycombCookieSameSite(cc.SameSite());
  cookie.priority = MakeHoneycombCookiePriority(cc.Priority());
...
bool MakeHoneycombCookie(const GURL& url,
  ...
  HoneycombString(&cookie.name).FromString(pc.Name());
  HoneycombString(&cookie.value).FromString(pc.Value());
  HoneycombString(&cookie.domain).FromString(cookie_domain);
  HoneycombString(&cookie.path).FromString(cookie_path);
  cookie.secure = pc.IsSecure();
  cookie.httponly = pc.IsHttpOnly();
  cookie.creation = HoneycombBaseTime(creation_time);
  cookie.last_access = HoneycombBaseTime(creation_time);
  cookie.has_expires = !cookie_expires.is_null();
  if (cookie.has_expires) {
    cookie.expires = HoneycombBaseTime(cookie_expires);
  }
  cookie.same_site = MakeHoneycombCookieSameSite(pc.SameSite());
  cookie.priority = MakeHoneycombCookiePriority(pc.Priority());
