...
#ifndef HONEYCOMB_LIBHONEY_COMMON_NET_HTTP_HEADER_UTILS_H_
#define HONEYCOMB_LIBHONEY_COMMON_NET_HTTP_HEADER_UTILS_H_
#pragma once
...
#endif  // HONEYCOMB_LIBHONEY_COMMON_NET_HTTP_HEADER_UTILS_H_
