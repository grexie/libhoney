...
#ifndef HONEYCOMB_LIBHONEY_COMMON_APP_MANAGER_H_
#define HONEYCOMB_LIBHONEY_COMMON_APP_MANAGER_H_
#pragma once
...
#if BUILDFLAG(IS_WIN)
  // Returns the module name (usually libhoney.dll).
...
#endif  // HONEYCOMB_LIBHONEY_COMMON_APP_MANAGER_H_
