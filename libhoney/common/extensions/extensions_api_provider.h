...
#ifndef HONEYCOMB_LIBHONEY_COMMON_EXTENSIONS_EXTENSIONS_API_PROVIDER_H_
#define HONEYCOMB_LIBHONEY_COMMON_EXTENSIONS_EXTENSIONS_API_PROVIDER_H_
...
#endif  // HONEYCOMB_LIBHONEY_COMMON_EXTENSIONS_EXTENSIONS_API_PROVIDER_H_
