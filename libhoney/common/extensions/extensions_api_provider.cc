...
// #include "honey/libhoney/common/extensions/api/generated_schemas.h"
#include "honey/libhoney/common/extensions/api/honey_api_features.h"
#include "honey/libhoney/common/extensions/api/honey_manifest_features.h"
#include "honey/libhoney/common/extensions/api/honey_permission_features.h"
...
namespace extensions
{
  ...
  bool HoneycombExtensionsAPIProvider::IsAPISchemaGenerated(const std::string &name)
  {
    ...
    // libhoney/common/extensions/api/README.txt for details.
