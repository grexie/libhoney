...
HoneycombValueController::HoneycombValueController()
...
void HoneycombValueController::SetOwner(void* value, Object* object) {
  DCHECK(value && object);
...
void HoneycombValueController::AddReference(void* value, Object* object) {
  DCHECK(value && object);
...
void HoneycombValueController::Remove(void* value, bool notify_object) {
  DCHECK(value);
...
HoneycombValueController::Object* HoneycombValueController::Get(void* value) {
  DCHECK(value);
...
void HoneycombValueController::AddDependency(void* parent, void* child) {
...
void HoneycombValueController::RemoveDependencies(void* value) {
  DCHECK(value);
...
void HoneycombValueController::TakeFrom(HoneycombValueController* other) {
  DCHECK(other);
...
void HoneycombValueController::Swap(void* old_value, void* new_value) {
