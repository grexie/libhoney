...
#ifndef HONEYCOMB_LIBHONEY_COMMON_CRASH_REPORTER_CLIENT_H_
#define HONEYCOMB_LIBHONEY_COMMON_CRASH_REPORTER_CLIENT_H_
...
#endif  // HONEYCOMB_LIBHONEY_COMMON_CRASH_REPORTER_CLIENT_H_
