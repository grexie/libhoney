...
#ifndef HONEYCOMB_LIBHONEY_COMMON_TASK_RUNNER_MANAGER_H_
#define HONEYCOMB_LIBHONEY_COMMON_TASK_RUNNER_MANAGER_H_
#pragma once
...
#endif  // HONEYCOMB_LIBHONEY_COMMON_TASK_RUNNER_MANAGER_H_
