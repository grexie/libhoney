...
#ifndef HONEYCOMB_LIBHONEY_COMMON_MAIN_RUNNER_DELEGATE_H_
#define HONEYCOMB_LIBHONEY_COMMON_MAIN_RUNNER_DELEGATE_H_
#pragma once
...
#endif  // HONEYCOMB_LIBHONEY_COMMON_MAIN_RUNNER_DELEGATE_H_
