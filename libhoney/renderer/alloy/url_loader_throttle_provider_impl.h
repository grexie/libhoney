...
#ifndef HONEYCOMB_LIBHONEY_RENDERER_ALLOY_URL_LOADER_THROTTLE_PROVIDER_IMPL_H_
#define HONEYCOMB_LIBHONEY_RENDERER_ALLOY_URL_LOADER_THROTTLE_PROVIDER_IMPL_H_
...
#endif  // HONEYCOMB_LIBHONEY_RENDERER_ALLOY_URL_LOADER_THROTTLE_PROVIDER_IMPL_H_
