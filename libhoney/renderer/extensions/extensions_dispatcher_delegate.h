...
#ifndef HONEYCOMB_LIBHONEY_RENDERER_EXTENSIONS_EXTENSIONS_DISPATCHER_DELEGATE_H_
#define HONEYCOMB_LIBHONEY_RENDERER_EXTENSIONS_EXTENSIONS_DISPATCHER_DELEGATE_H_
...
#endif  // HONEYCOMB_LIBHONEY_RENDERER_EXTENSIONS_EXTENSIONS_DISPATCHER_DELEGATE_H_
