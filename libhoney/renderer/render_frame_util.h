...
#ifndef HONEYCOMB_LIBHONEY_RENDERER_RENDER_FRAME_UTIL_H_
#define HONEYCOMB_LIBHONEY_RENDERER_RENDER_FRAME_UTIL_H_
...
#endif  // HONEYCOMB_LIBHONEY_RENDERER_RENDER_FRAME_UTIL_H_
