...
// Honeycomb and Chromium support a wide range of command-line switches. This file
// only contains command-line switches specific to the honeyclient application.
// View Honeycomb documentation or search for *_switches.cc files in the
...
//   honey/libhoneycomb/common/honey_switches.cc
