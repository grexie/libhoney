...
#ifndef HONEYCOMB_TESTS_HONEYCOMBCLIENT_RENDERER_PERFORMANCE_TEST_SETUP_H_
#define HONEYCOMB_TESTS_HONEYCOMBCLIENT_RENDERER_PERFORMANCE_TEST_SETUP_H_
#pragma once
...
class HoneycombTimer {
 public:
  HoneycombTimer() : running_(false) {}
