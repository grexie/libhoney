...
#ifndef HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_WINDOW_TEST_RUNNER_MAC_H_
#define HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_WINDOW_TEST_RUNNER_MAC_H_
#pragma once
...
#endif  // HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_WINDOW_TEST_RUNNER_MAC_H_
