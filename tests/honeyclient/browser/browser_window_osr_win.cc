...
void BrowserWindowOsrWin::GetPopupConfig(HoneycombWindowHandle temp_handle,
...
void BrowserWindowOsrWin::OnBrowserClosed(HoneycombRefPtr<HoneycombBrowser> browser) {
  REQUIRE_MAIN_THREAD();
