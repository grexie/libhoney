...
#ifndef HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_BROWSER_WINDOW_STD_WIN_H_
#define HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_BROWSER_WINDOW_STD_WIN_H_
#pragma once
...
#endif  // HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_BROWSER_WINDOW_STD_WIN_H_
