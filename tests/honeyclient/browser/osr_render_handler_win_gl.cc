...
void OsrRenderHandlerWinGL::Initialize(HoneycombRefPtr<HoneycombBrowser> browser) {
...
void OsrRenderHandlerWinGL::OnPopupShow(HoneycombRefPtr<HoneycombBrowser> browser,
                                        bool show) {
  HONEYCOMB_REQUIRE_UI_THREAD();
...
void OsrRenderHandlerWinGL::OnPopupSize(HoneycombRefPtr<HoneycombBrowser> browser,
