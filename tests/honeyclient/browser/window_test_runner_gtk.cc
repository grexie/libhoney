...
void SetPosImpl(HoneycombRefPtr<HoneycombBrowser> browser,
  ...
  HoneycombRect display_rect(rect.x, rect.y, rect.width, rect.height);
...
void WindowTestRunnerGtk::SetPos(HoneycombRefPtr<HoneycombBrowser> browser,
                                 int x,
                                 int y,
                                 int width,
                                 int height) {
...
void WindowTestRunnerGtk::Minimize(HoneycombRefPtr<HoneycombBrowser> browser) {
  MAIN_POST_CLOSURE(base::BindOnce(MinimizeImpl, browser));
}

void WindowTestRunnerGtk::Maximize(HoneycombRefPtr<HoneycombBrowser> browser) {
  MAIN_POST_CLOSURE(base::BindOnce(MaximizeImpl, browser));
}

void WindowTestRunnerGtk::Restore(HoneycombRefPtr<HoneycombBrowser> browser) {
