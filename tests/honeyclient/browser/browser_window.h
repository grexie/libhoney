...
#ifndef HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_BROWSER_WINDOW_H_
#define HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_BROWSER_WINDOW_H_
#pragma once
...
class BrowserWindow : public ClientHandler::Delegate {
 public:
  ...
  virtual void CreateBrowser(ClientWindowHandle parent_handle,
                             ...
                             HoneycombRefPtr<HoneycombRequestContext> request_context) = 0;
  ...
  virtual void GetPopupConfig(HoneycombWindowHandle temp_handle,
...
#endif  // HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_BROWSER_WINDOW_H_
