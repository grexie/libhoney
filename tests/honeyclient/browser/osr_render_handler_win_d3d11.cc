...
void PopupLayer::set_bounds(const HoneycombRect& bounds) {
...
bool OsrRenderHandlerWinD3D11::Initialize(HoneycombRefPtr<HoneycombBrowser> browser,
                                          int width,
                                          int height) {
...
void OsrRenderHandlerWinD3D11::OnPopupShow(HoneycombRefPtr<HoneycombBrowser> browser,
                                           bool show) {
  HONEYCOMB_REQUIRE_UI_THREAD();
...
void OsrRenderHandlerWinD3D11::OnPopupSize(HoneycombRefPtr<HoneycombBrowser> browser,
