...
#ifndef HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_MAIN_CONTEXT_IMPL_H_
#define HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_MAIN_CONTEXT_IMPL_H_
#pragma once
...
class MainContextImpl : public MainContext {
 public:
  MainContextImpl(HoneycombRefPtr<HoneycombCommandLine> command_line,
  ...
  void PopulateSettings(HoneycombSettings* settings) override;
  void PopulateBrowserSettings(HoneycombBrowserSettings* settings) override;
  void PopulateOsrSettings(OsrRendererSettings* settings) override;
  RootWindowManager* GetRootWindowManager() override;

  // Initialize Honeycomb and associated main context state. This method must be
  ...
  // Shut down Honeycomb and associated context state. This method must be called on
 ...
 private:
  ...
  honey_color_t background_color_ = 0;
  honey_color_t browser_background_color_ = 0;
...
#endif  // HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_MAIN_CONTEXT_IMPL_H_
