...
void BrowserWindowStdMac::GetPopupConfig(HoneycombWindowHandle temp_handle,
...
void BrowserWindowStdMac::ShowPopup(ClientWindowHandle parent_handle,
  ...
  NSView* browser_view = CAST_HONEYCOMB_WINDOW_HANDLE_TO_NSVIEW(GetWindowHandle());

  // Re-parent |browser_view| to |parent_handle|.
  [browser_view removeFromSuperview];
  [CAST_HONEYCOMB_WINDOW_HANDLE_TO_NSVIEW(parent_handle) addSubview:browser_view];
