...
#include "tests/honeyclient/browser/browser_window_osr_gtk.h"
...
#include "tests/honeyclient/browser/util_gtk.h"
...
int GetHoneycombStateModifiers(guint state) {
  int modifiers = 0;
...
HoneycombBrowserHost::DragOperationsMask GetDragOperationsMask(
  ...
  return static_cast<HoneycombBrowserHost::DragOperationsMask>(allowed_ops);
}
...
void BrowserWindowOsrGtk::CreateBrowser(
  ...
  HoneycombWindowHandle handle = GDK_WINDOW_XID(gtk_widget_get_window(window));
  DCHECK(handle);
...
void BrowserWindowOsrGtk::GetPopupConfig(HoneycombWindowHandle temp_handle,
...
void BrowserWindowOsrGtk::OnAfterCreated(HoneycombRefPtr<HoneycombBrowser> browser) {
  HONEYCOMB_REQUIRE_UI_THREAD();
}

void BrowserWindowOsrGtk::OnBeforeClose(HoneycombRefPtr<HoneycombBrowser> browser) {
  HONEYCOMB_REQUIRE_UI_THREAD();
...
bool BrowserWindowOsrGtk::GetRootScreenRect(HoneycombRefPtr<HoneycombBrowser> browser,
                                            HoneycombRect& rect) {
  HONEYCOMB_REQUIRE_UI_THREAD();
  return false;
}

void BrowserWindowOsrGtk::GetViewRect(HoneycombRefPtr<HoneycombBrowser> browser,
                                      HoneycombRect& rect) {
  HONEYCOMB_REQUIRE_UI_THREAD();
...
bool BrowserWindowOsrGtk::GetScreenPoint(HoneycombRefPtr<HoneycombBrowser> browser,
                                         int viewX,
                                         int viewY,
                                         int& screenX,
                                         int& screenY) {
...
bool BrowserWindowOsrGtk::GetScreenInfo(HoneycombRefPtr<HoneycombBrowser> browser,
...
void BrowserWindowOsrGtk::OnPopupShow(HoneycombRefPtr<HoneycombBrowser> browser,
                                      bool show) {
  HONEYCOMB_REQUIRE_UI_THREAD();
...
void BrowserWindowOsrGtk::OnPopupSize(HoneycombRefPtr<HoneycombBrowser> browser,
                                      const HoneycombRect& rect) {
  HONEYCOMB_REQUIRE_UI_THREAD();
...
void BrowserWindowOsrGtk::OnPaint(HoneycombRefPtr<HoneycombBrowser> browser,
...
void BrowserWindowOsrGtk::UpdateAccessibilityTree(HoneycombRefPtr<HoneycombValue> value) {
  HONEYCOMB_REQUIRE_UI_THREAD();
}
...
gint BrowserWindowOsrGtk::ClickEvent(GtkWidget* widget,
  ...
  HoneycombRefPtr<HoneycombBrowserHost> host = self->browser_->GetHost();

  HoneycombBrowserHost::MouseButtonType button_type = MBT_LEFT;
  switch (event->button) {
    case 1:
      break;
    case 2:
  ...
  mouse_event.modifiers = GetHoneycombStateModifiers(event->state);
...
gint BrowserWindowOsrGtk::KeyEvent(GtkWidget* widget,
  ...
  key_event.modifiers = GetHoneycombStateModifiers(event->state);
...
gint BrowserWindowOsrGtk::MoveEvent(GtkWidget* widget,
  ...
  self->ApplyPopupOffset(mouse_event.x, mouse_event.y);
  DeviceToLogical(mouse_event, device_scale_factor);
  mouse_event.modifiers = GetHoneycombStateModifiers(state);
...
gboolean BrowserWindowOsrGtk::TouchEvent(GtkWidget* widget,
  ...
  touch_event.modifiers = GetHoneycombStateModifiers(event->state);
...
bool BrowserWindowOsrGtk::IsOverPopupWidget(int x, int y) const {
  const HoneycombRect& rc = renderer_.popup_rect();
...
void BrowserWindowOsrGtk::RegisterDragDrop() {
  ...
  // Succession of Honeycomb d&d calls:
...
void BrowserWindowOsrGtk::DragBegin(GtkWidget* widget,
  ...
  int pixel_width = 0;
  int pixel_height = 0;
  HoneycombRefPtr<HoneycombBinaryValue> image_binary =
  ...
  if (error == nullptr && loader) {
    ...
    if (success) {
      ...
      if (success) {
        ...
        if (pixbuf) {
          HoneycombPoint image_hotspot = self->drag_data_->GetImageHotspot();
