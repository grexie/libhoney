...
#ifndef HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_ROOT_WINDOW_H_
#define HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_ROOT_WINDOW_H_
#pragma once
...
class RootWindow
 ...
 public:
  ...
  class Delegate {
   public:
    // Called to retrieve the HoneycombRequestContext for browser. Only called for
    // non-popup browsers. May return nullptr.
    virtual HoneycombRefPtr<HoneycombRequestContext> GetRequestContext(
    ...
    virtual void OnBrowserCreated(RootWindow* root_window,
                                  HoneycombRefPtr<HoneycombBrowser> browser) = 0;
  ...
  virtual void Init(RootWindow::Delegate* delegate,
                    ...
                    const HoneycombBrowserSettings& settings) = 0;
  ...
  virtual void InitAsPopup(RootWindow::Delegate* delegate,
                           ...
                           HoneycombBrowserSettings& settings) = 0;
  ...
  virtual HoneycombRefPtr<HoneycombBrowser> GetBrowser() const = 0;
...
#endif  // HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_ROOT_WINDOW_H_
