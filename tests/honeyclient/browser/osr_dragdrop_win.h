...
#ifndef HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_OSR_DRAGDROP_WIN_H_
#define HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_OSR_DRAGDROP_WIN_H_
#pragma once

// When generating projects with CMake the HONEYCOMB_USE_ATL value will be defined
...
#include "tests/honeyclient/browser/osr_dragdrop_events.h"
...
class DropTargetWin : public IDropTarget {
 public:
  ...
  HoneycombBrowserHost::DragOperationsMask StartDragging(
...
#endif  // HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_OSR_DRAGDROP_WIN_H_
