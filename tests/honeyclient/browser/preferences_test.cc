...
class Handler : public HoneycombMessageRouterBrowserSide::Handler {
 public:
  ...
  // Called due to honeyQuery execution in preferences.html.
  bool OnQuery(HoneycombRefPtr<HoneycombBrowser> browser,
    ...
    if (message_name == kNameValueGet) {
      ...
      HoneycombRefPtr<HoneycombDictionaryValue> preferences =
 ...
 private:
  ...
  static void OnPreferencesGet(HoneycombRefPtr<HoneycombBrowser> browser,
    ...
    HoneycombRefPtr<HoneycombDictionaryValue> prefs =
  ...
  static void OnPreferencesSet(HoneycombRefPtr<HoneycombBrowser> browser,
                               HoneycombRefPtr<HoneycombDictionaryValue> preferences,
                               HoneycombRefPtr<Callback> callback) {
    HoneycombRefPtr<HoneycombRequestContext> context =
        browser->GetHost()->GetRequestContext();
  ...
  static void OnPreferencesState(HoneycombRefPtr<HoneycombBrowser> browser,
                                 HoneycombRefPtr<Callback> callback) {
  ...
  static HoneycombString GetJSON(HoneycombRefPtr<HoneycombDictionaryValue> dictionary) {
    HoneycombRefPtr<HoneycombValue> value = HoneycombValue::Create();
  ...
  static bool ApplyPrefs(HoneycombRefPtr<HoneycombRequestContext> context,
  ...
  static bool SetPref(HoneycombRefPtr<HoneycombRequestContext> context,
                      const std::string& name,
                      HoneycombRefPtr<HoneycombValue> value,
                      std::string& error,
                      NameVector& changed_names) {
    HoneycombRefPtr<HoneycombValue> existing_value = context->GetPreference(name);
