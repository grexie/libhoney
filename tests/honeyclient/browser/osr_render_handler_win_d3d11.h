...
#ifndef HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_OSR_RENDER_HANDLER_WIN_D3D11_H_
#define HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_OSR_RENDER_HANDLER_WIN_D3D11_H_
#pragma once

#include "tests/honeyclient/browser/osr_d3d11_win.h"
...
class PopupLayer : public BrowserLayer {
 public:
  ...
  void set_bounds(const HoneycombRect& bounds);
 ...
 private:
  HoneycombRect original_bounds_;
  HoneycombRect bounds_;
...
class OsrRenderHandlerWinD3D11 : public OsrRenderHandlerWin {
 public:
  ...
  bool Initialize(HoneycombRefPtr<HoneycombBrowser> browser, int width, int height);
...
#endif  // HONEYCOMB_TESTS_HONEYCOMBCLIENT_BROWSER_OSR_RENDER_HANDLER_WIN_D3D11_H_
