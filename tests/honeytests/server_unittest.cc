...
class TestServerHandler : public HoneycombServerHandler {
 public:
  // HTTP test handler.
  ...
  class HttpRequestHandler {
   public:
    ...
    virtual bool HandleRequest(HoneycombRefPtr<HoneycombServer> server,
                               int connection_id,
  ...
  class WsRequestHandler {
   public:
    ...
    virtual bool HandleRequest(HoneycombRefPtr<HoneycombServer> server,
                               ...
                               HoneycombRefPtr<HoneycombCallback> callback) = 0;
    virtual bool HandleConnected(HoneycombRefPtr<HoneycombServer> server,
                                 int connection_id) = 0;
    virtual bool HandleMessage(HoneycombRefPtr<HoneycombServer> server,
                               int connection_id,
                               const void* data,
                               size_t data_size) = 0;
    virtual bool VerifyResults() = 0;
  ...
  void CreateServer() {
    EXPECT_FALSE(initialized_);
    initialized_ = true;
    HoneycombServer::CreateServer(kTestServerAddress, kTestServerPort, 10, this);
  }
 ...
 private:
  ...
  bool VerifyServer(HoneycombRefPtr<HoneycombServer> server) {
    V_DECLARE();
  ...
  bool VerifyRequest(HoneycombRefPtr<HoneycombRequest> request, bool is_websocket) {
    V_DECLARE();
    ...
    HoneycombRefPtr<HoneycombPostData> post_data = request->GetPostData();
    if (post_data) {
 ...
 private:
  ...
  HoneycombRefPtr<HoneycombTaskRunner> server_runner_;
  bool initialized_;
...
// Works similarly to TestHandler but without the HoneycombClient dependencies.
class HttpTestRunner : public base::RefCountedThreadSafe<HttpTestRunner> {
 public:
  ...
  void ExecuteTest() {
    EXPECT_FALSE(HoneycombCurrentlyOn(TID_UI));
    ...
    run_event_ = HoneycombWaitableEvent::CreateWaitableEvent(false, false);

    HoneycombPostTask(TID_UI, base::BindOnce(&HttpTestRunner::RunTest, this));
 ...
 private:
  ...
  void OnServerDestroyed() {
    ...
    HoneycombPostTask(TID_UI, base::BindOnce(&HttpTestRunner::DestroyTest, this));
  }
  ...
  HoneycombRefPtr<HoneycombWaitableEvent> run_event_;
  HoneycombRefPtr<HoneycombWaitableEvent> destroy_event_;
  HoneycombRefPtr<TestServerHandler> handler_;
  bool initialized_;
...
// HoneycombServer::SendHttp*Response().
struct HttpServerResponse {
  ...
  int response_code;
  HoneycombServer::HeaderMap extra_headers;
  bool no_content_length;
};

void SendHttpServerResponse(HoneycombRefPtr<HoneycombServer> server,
                            int connection_id,
...
std::string GetHeaderValue(const HoneycombServer::HeaderMap& header_map,
  ...
  HoneycombServer::HeaderMap::const_iterator it = header_map.find(header_name);
...
void VerifyHttpServerResponse(const HttpServerResponse& expected_response,
  ...
  HoneycombServer::HeaderMap header_map;
...
HoneycombRefPtr<HoneycombRequest> CreateTestServerRequest(
    const std::string& path,
    const std::string& method,
    const std::string& data = std::string(),
    const std::string& content_type = std::string(),
    const HoneycombRequest::HeaderMap& extra_headers = HoneycombRequest::HeaderMap()) {
  ...
  if (!data.empty()) {
    HoneycombRefPtr<HoneycombPostData> post_data = HoneycombPostData::Create();
...
class StaticHttpServerRequestHandler
 ...
 public:
  StaticHttpServerRequestHandler(HoneycombRefPtr<HoneycombRequest> expected_request,
  ...
  bool HandleRequest(HoneycombRefPtr<HoneycombServer> server,
                     int connection_id,
                     const HoneycombString& client_address,
                     HoneycombRefPtr<HoneycombRequest> request) override {
 ...
 private:
  HoneycombRefPtr<HoneycombRequest> expected_request_;
...
// response.
class StaticHttpURLRequestClient : public HoneycombURLRequestClient {
 public:
  using ResponseCallback =
      base::OnceCallback<void(honey_errorcode_t /* error */,
                              HoneycombRefPtr<HoneycombResponse> /* response */,
                              const std::string& /* data */)>;

  // |response_callback| will be executed on the UI thread when the response
  // is complete.
  StaticHttpURLRequestClient(HoneycombRefPtr<HoneycombRequest> request,
  ...
  void RunRequest() {
    EXPECT_UI_THREAD();
    HoneycombURLRequest::Create(request_, this, nullptr);
  }
...
class StaticHttpRequestRunner : public HttpTestRunner::RequestRunner {
 public:
  StaticHttpRequestRunner(HoneycombRefPtr<HoneycombRequest> request,
                          const HttpServerResponse& response)
  ...
  static std::unique_ptr<HttpTestRunner::RequestRunner> Create200(
    ...
    HoneycombRefPtr<HoneycombRequest> request = CreateTestServerRequest(path, "GET");
  ...
  static std::unique_ptr<HttpTestRunner::RequestRunner> CreateCustom(
    ...
    HoneycombRequest::HeaderMap request_headers;
    ...
    HoneycombRefPtr<HoneycombRequest> request = CreateTestServerRequest(
 ...
 private:
  void OnResponseComplete(honey_errorcode_t error,
                          HoneycombRefPtr<HoneycombResponse> response,
                          const std::string& data) {
    EXPECT_UI_THREAD();
  ...
  HoneycombRefPtr<StaticHttpURLRequestClient> request_client_;
...
TEST(ServerTest, HttpSingle200) {
  HoneycombRefPtr<HttpTestRunner> runner = new HttpTestRunner(false);
...
TEST(ServerTest, HttpMultipleParallel200) {
  HoneycombRefPtr<HttpTestRunner> runner = new HttpTestRunner(true);
...
class WebSocketTestHandler : public RoutingTestHandler {
 ...
 protected:
  ...
  virtual void OnHandlerCreated(HoneycombRefPtr<TestServerHandler> handler) = 0;
...
class EchoWebSocketRequestHandler : public TestServerHandler::WsRequestHandler {
 public:
  ...
  bool HandleConnected(HoneycombRefPtr<HoneycombServer> server,
                       int connection_id) override {
    return true;
  }

  bool HandleMessage(HoneycombRefPtr<HoneycombServer> server,
                     int connection_id,
                     const void* data,
                     size_t data_size) override {
    actual_message_ct_++;
...
class EchoWebSocketTestHandler : public WebSocketTestHandler {
 public:
  ...
  void OnHandlerCreated(HoneycombRefPtr<TestServerHandler> handler) override {
...
TEST(ServerTest, WebSocketSingleConnectionSingleMessage) {
  HoneycombRefPtr<EchoWebSocketTestHandler> handler =
