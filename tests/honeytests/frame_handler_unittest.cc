...
// Must match HoneycombFrameHostImpl::kInvalidFrameId.
...
struct FrameStatus {
  ...
  static std::string GetFrameDebugString(HoneycombRefPtr<HoneycombFrame> frame) {
  ...
  FrameStatus(HoneycombRefPtr<HoneycombFrame> frame)
  ...
  bool IsSame(HoneycombRefPtr<HoneycombFrame> frame) const {
  ...
  void OnLoadEnd(HoneycombRefPtr<HoneycombBrowser> browser, HoneycombRefPtr<HoneycombFrame> frame) {
    EXPECT_UI_THREAD();
    VerifyBrowser(__FUNCTION__, browser);
    VerifyFrame(__FUNCTION__, frame);
  ...
  void OnQuery(HoneycombRefPtr<HoneycombBrowser> browser,
               HoneycombRefPtr<HoneycombFrame> frame,
 ...
 private:
  ...
  void VerifyBrowser(const std::string& func,
                     HoneycombRefPtr<HoneycombBrowser> browser) const {
    ...
    // browser before the HoneycombFrameHandler callbacks related to main frame change
  ...
  void ExecuteQuery(HoneycombRefPtr<HoneycombFrame> frame, int callback) {
    EXPECT_UI_THREAD();
...
class OrderMainTestHandler : public RoutingTestHandler, public HoneycombFrameHandler {
 public:
...
TEST(FrameHandlerTest, OrderMain) {
  HoneycombRefPtr<OrderMainTestHandler> handler = new OrderMainTestHandler();
  handler->ExecuteTest();
...
TEST(FrameHandlerTest, OrderMainNavSameOrigin) {
  HoneycombRefPtr<NavigateOrderMainTestHandler> handler =
...
class FrameStatusMap {
 public:
  ...
  bool Contains(HoneycombRefPtr<HoneycombFrame> frame) const {
    return frame_map_.find(frame->GetIdentifier()) != frame_map_.end();
  }

  FrameStatus* CreateFrameStatus(HoneycombRefPtr<HoneycombFrame> frame) {
    EXPECT_UI_THREAD();
  ...
  FrameStatus* GetFrameStatus(HoneycombRefPtr<HoneycombFrame> frame) const {
    EXPECT_UI_THREAD();
  ...
  void RemoveFrameStatus(HoneycombRefPtr<HoneycombFrame> frame) {
    const int64_t id = frame->GetIdentifier();
...
class OrderSubTestHandler : public NavigateOrderMainTestHandler {
 ...
 protected:
  ...
  FrameStatusMap* GetFrameMap(HoneycombRefPtr<HoneycombFrame> frame) const {
    for (auto& map : frame_maps_) {
 ...
 private:
  ...
  FrameStatusMap* GetOrCreateFrameMap(HoneycombRefPtr<HoneycombFrame> frame) {
...
TEST(FrameHandlerTest, OrderSubSameOriginPeers) {
  HoneycombRefPtr<OrderSubTestHandler> handler =
...
TEST(FrameHandlerTest, OrderSubCrossOriginPeers) {
  HoneycombRefPtr<CrossOriginOrderSubTestHandler> handler =
...
class ParentOrderMainTestHandler : public OrderMainTestHandler {
 public:
  ParentOrderMainTestHandler(CompletionState* completion_state,
                             HoneycombRefPtr<PopupOrderMainTestHandler> popup_handler)
  ...
  void OnAfterCreated(HoneycombRefPtr<HoneycombBrowser> browser) override {
    ...
    browser->GetMainFrame()->ExecuteJavaScript(
        "window.open('" + popup_handler_->GetMainURL() + "');", HoneycombString(), 0);
  }
 ...
 private:
  ...
  HoneycombRefPtr<PopupOrderMainTestHandler> popup_handler_;
...
void RunOrderMainPopupTest(bool cross_origin) {
  ...
  HoneycombRefPtr<ParentOrderMainTestHandler> parent_handler =
