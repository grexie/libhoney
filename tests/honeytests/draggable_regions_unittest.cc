...
class DraggableRegionsTestHandler : public TestHandler,
 ...
 public:
  ...
  HoneycombRefPtr<HoneycombFrameHandler> GetFrameHandler() override { return this; }
 ...
 private:
  void NextTest(HoneycombRefPtr<HoneycombBrowser> browser) {
...
TEST(DraggableRegionsTest, DraggableRegionsSameOrigin) {
  HoneycombRefPtr<DraggableRegionsTestHandler> handler =
