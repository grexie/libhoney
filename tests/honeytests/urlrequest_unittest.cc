...
struct RequestRunSettings {
  ...
  void SetRequestFailureExpected(honey_errorcode_t error_code) {
  ...
  HoneycombURLRequest::Status expected_status = UR_SUCCESS;

  // Expected error code value.
  HoneycombURLRequest::ErrorCode expected_error_code = ERR_NONE;
  ...
  // HoneycombRequestContext::ClearHttpAuthCredentials should be called to avoid
  ...
  HoneycombRefPtr<HoneycombRequest> redirect_request;
  HoneycombRefPtr<HoneycombResponse> redirect_response;
...
class RequestDataMap {
 public:
  ...
  RequestDataMap() : owner_task_runner_(HoneycombTaskRunner::GetForCurrentThread()) {}

  // Pass ownership to the specified |task_runner| thread.
  // If |task_runner| is nullptr the test is considered destroyed.
  void SetOwnerTaskRunner(HoneycombRefPtr<HoneycombTaskRunner> task_runner) {
 ...
 private:
  HoneycombRefPtr<HoneycombTaskRunner> owner_task_runner_;
  ...
  typedef std::map<std::string,
                   std::pair<HoneycombRefPtr<HoneycombRequest>, HoneycombRefPtr<HoneycombResponse>>>
      RedirectDataMap;
...
void SetUploadData(HoneycombRefPtr<HoneycombRequest> request, const std::string& data) {
  HoneycombRefPtr<HoneycombPostData> postData = HoneycombPostData::Create();
  HoneycombRefPtr<HoneycombPostDataElement> element = HoneycombPostDataElement::Create();
  element->SetToBytes(data.size(), data.c_str());
  postData->AddElement(element);
  request->SetPostData(postData);
}

void SetUploadFile(HoneycombRefPtr<HoneycombRequest> request, const std::string& file) {
  HoneycombRefPtr<HoneycombPostData> postData = HoneycombPostData::Create();
  HoneycombRefPtr<HoneycombPostDataElement> element = HoneycombPostDataElement::Create();
...
void GetUploadData(HoneycombRefPtr<HoneycombRequest> request, std::string& data) {
  ...
  HoneycombRefPtr<HoneycombPostDataElement> element = elements[0];
...
void SetTestCookie(HoneycombRefPtr<HoneycombRequestContext> request_context,
                   bool server_backend,
                   base::OnceClosure callback) {
  class Callback : public HoneycombSetCookieCallback {
   public:
  ...
  HoneycombString(&cookie.name) = kRequestSendCookieName;
  HoneycombString(&cookie.value) = "send-cookie-value";
  HoneycombString(&cookie.domain) = GetRequestHost(server_backend, false);
  HoneycombString(&cookie.path) = "/";
...
// time.
void GetTestCookie(HoneycombRefPtr<HoneycombRequestContext> request_context,
                   bool server_backend,
                   GetTestCookieCallback callback) {
  class Visitor : public HoneycombCookieVisitor {
   public:
    ...
    bool Visit(const HoneycombCookie& cookie,
      ...
      std::string cookie_name = HoneycombString(&cookie.name);
  ...
  HoneycombRefPtr<HoneycombCookieManager> cookie_manager =
...
std::string GetHeaderValue(const HoneycombRequest::HeaderMap& header_map,
                           const std::string& header_name_lower) {
  HoneycombRequest::HeaderMap::const_iterator it = header_map.begin();
...
void VerifyNormalRequest(const RequestRunSettings* settings,
  ...
  // HONEYCOMB_SETTINGS_ACCEPT_LANGUAGE value from HoneycombSettings.accept_language_list
  // set in HoneycombTestSuite::GetSettings() and expanded internally by
...
void GetAuthResponse(HoneycombRefPtr<HoneycombResponse> response) {
...
bool IsAuthorized(HoneycombRefPtr<HoneycombRequest> request,
  ...
  if (authHeader.find("Basic ") == 0) {
    ...
    HoneycombRefPtr<HoneycombBinaryValue> data = HoneycombBase64Decode(base64);
    EXPECT_TRUE(data);
    if (!data) {
...
class RequestSchemeHandlerOld : public HoneycombResourceHandler {
 public:
...
class RequestSchemeHandler : public HoneycombResourceHandler {
 public:
...
class RequestRedirectSchemeHandlerOld : public HoneycombResourceHandler {
 public:
  RequestRedirectSchemeHandlerOld(HoneycombRefPtr<HoneycombRequest> request,
                                  HoneycombRefPtr<HoneycombResponse> response,
                                  base::OnceClosure destroy_callback)
      : request_(request),
        response_(response),
...
class RequestRedirectSchemeHandler : public HoneycombResourceHandler {
 public:
  RequestRedirectSchemeHandler(HoneycombRefPtr<HoneycombRequest> request,
                               HoneycombRefPtr<HoneycombResponse> response,
                               base::OnceClosure destroy_callback)
      : request_(request),
        response_(response),
...
class IncompleteSchemeHandlerOld : public HoneycombResourceHandler {
 public:
 ...
 private:
  ...
  HoneycombRefPtr<HoneycombCallback> incomplete_callback_;

  IMPLEMENT_REFCOUNTING(IncompleteSchemeHandlerOld);
  DISALLOW_COPY_AND_ASSIGN(IncompleteSchemeHandlerOld);
};

class IncompleteSchemeHandler : public HoneycombResourceHandler {
 public:
 ...
 private:
  ...
  HoneycombRefPtr<HoneycombCallback> incomplete_open_callback_;
  HoneycombRefPtr<HoneycombResourceReadCallback> incomplete_read_callback_;

  IMPLEMENT_REFCOUNTING(IncompleteSchemeHandler);
  DISALLOW_COPY_AND_ASSIGN(IncompleteSchemeHandler);
};

class RequestSchemeHandlerFactory : public HoneycombSchemeHandlerFactory {
 public:
  ...
  void Shutdown(base::OnceClosure complete_callback) {
    if (!HoneycombCurrentlyOn(TID_IO)) {
      HoneycombPostTask(TID_IO, base::BindOnce(&RequestSchemeHandlerFactory::Shutdown,
...
class RequestServerHandler : public test_server::ObserverHelper {
 ...
 private:
  ...
  bool HandleRequest(HoneycombRefPtr<HoneycombRequest> request,
  ...
  static bool HandleAuthRequest(HoneycombRefPtr<HoneycombRequest> request,
                                const ResponseCallback& response_callback) {
    HoneycombRefPtr<HoneycombResponse> response = HoneycombResponse::Create();
    GetAuthResponse(response);
    response_callback.Run(response, std::string());
    return true;
  }

  static bool HandleNormalRequest(HoneycombRefPtr<HoneycombRequest> request,
                                  const ResponseCallback& response_callback,
                                  RequestRunSettings* settings) {
  ...
  static bool HandleRedirectRequest(HoneycombRefPtr<HoneycombRequest> request,
                                    const ResponseCallback& response_callback,
                                    HoneycombRefPtr<HoneycombRequest> redirect_request,
                                    HoneycombRefPtr<HoneycombResponse> redirect_response) {
    if (redirect_response->GetStatus() == 302) {
      ...
      HoneycombResponse::HeaderMap redirectHeaderMap;
  ...
  void RunCompleteCallback(bool startup) {
    ...
    if (startup) {
      ...
      data_map_.SetOwnerTaskRunner(HoneycombTaskRunner::GetForCurrentThread());
    }
...
class RequestTestRunner : public base::RefCountedThreadSafe<RequestTestRunner> {
 public:
  ...
  RequestTestRunner(bool is_server_backend,
    ...
    owner_task_runner_ = HoneycombTaskRunner::GetForCurrentThread();
...
#define REGISTER_TEST(test_mode, setup_method, run_method)                  \
  ...
  void SetRequestContext(HoneycombRefPtr<HoneycombRequestContext> request_context) {
    request_context_ = request_context;
  }
  HoneycombRefPtr<HoneycombRequestContext> GetRequestContext() const {
 ...
 private:
  ...
  void SetupContinue(base::OnceClosure complete_callback) {
    if (!owner_task_runner_->BelongsToCurrentThread()) {
      owner_task_runner_->PostTask(HoneycombCreateClosureTask(
  ...
  void SetupGetTestShared() {
    settings_.request = HoneycombRequest::Create();
    settings_.request->SetURL(GetTestURL("GetTest.html"));
    settings_.request->SetMethod("GET");

    settings_.response = HoneycombResponse::Create();
  ...
  void SetupGetRedirectTest(base::OnceClosure complete_callback) {
    ...
    settings_.redirect_request = HoneycombRequest::Create();
    settings_.redirect_request->SetURL(GetTestURL("redirect.html"));
    settings_.redirect_request->SetMethod("GET");

    settings_.redirect_response = HoneycombResponse::Create();
  ...
  void SetupPostFileTestContinue(base::OnceClosure complete_callback) {
    EXPECT_TRUE(HoneycombCurrentlyOn(TID_FILE_USER_VISIBLE));
  ...
  void SendRequest(test_request::RequestDoneCallback done_callback) {
    ...
    // Not delegating to HoneycombRequestHandler::GetAuthCredentials.
  ...
  void VerifyResponse(const test_request::State* const client) {
    HoneycombRefPtr<HoneycombRequest> expected_request;
    HoneycombRefPtr<HoneycombResponse> expected_response;
  ...
  void AddSchemeHandler(base::OnceClosure complete_callback) {
    ...
    scheme_factory_->SetOwnerTaskRunner(HoneycombTaskRunner::GetForThread(TID_IO));
  ...
  HoneycombRefPtr<RequestSchemeHandlerFactory> scheme_factory_;

  HoneycombScopedTempDir post_file_tmpdir_;
...
class RequestTestHandler : public TestHandler {
 public:
  ...
  void PreSetupContinue() {
    ...
    if (context_mode_ == CONTEXT_GLOBAL) {
      ...
      if (context_mode_ == CONTEXT_ONDISK) {
        ...
        HoneycombString(&settings.cache_path) = context_tmpdir_path_;
      }

      if (!test_server_backend_) {
        // Set the schemes that are allowed to store cookies.
        HoneycombString(&settings.cookieable_schemes_list) = GetRequestScheme(false);
      }

      // Create a new temporary request context. Calls OnContextInitialized.
      HoneycombRequestContext::CreateContext(settings,
                                       new RequestContextHandler(this));
    }
  }

  void OnContextInitialized(HoneycombRefPtr<HoneycombRequestContext> request_context) {
    EXPECT_TRUE(HoneycombCurrentlyOn(TID_UI));
    EXPECT_TRUE(request_context.get());
    test_runner_->SetRequestContext(request_context);
    PreSetupComplete();
  ...
  void PostRunComplete(bool has_save_cookie) {
    if (!HoneycombCurrentlyOn(TID_UI)) {
      HoneycombPostTask(TID_UI, base::BindOnce(&RequestTestHandler::PostRunComplete,
  ...
  void DestroyTest() override {
    ...
    // HoneycombRequestHandler::GetAuthCredentials should be called after
    // HoneycombURLRequestClient::GetAuthCredentials when the request has an
    // associated frame.
 ...
 private:
  ...
  class RequestContextHandler : public HoneycombRequestContextHandler {
   public:
    explicit RequestContextHandler(HoneycombRefPtr<RequestTestHandler> test_handler)
   ...
   private:
    HoneycombRefPtr<RequestTestHandler> test_handler_;
  ...
  HoneycombRefPtr<HoneycombFrame> test_frame_;
  int test_frame_resource_load_ct_ = 0;

  HoneycombScopedTempDir context_tmpdir_;
  HoneycombString context_tmpdir_path_;
...
void RegisterURLRequestCustomSchemes(HoneycombRawPtr<HoneycombSchemeRegistrar> registrar) {
  const std::string& scheme = GetRequestScheme(false);
  registrar->AddCustomScheme(
      scheme, HONEYCOMB_SCHEME_OPTION_STANDARD | HONEYCOMB_SCHEME_OPTION_CORS_ENABLED);
}
...
#define REQ_TEST(name, test_mode, context_mode, test_server_backend,      \
  ...
  TEST(URLRequestTest, name) {                                            \
    HoneycombRefPtr<RequestTestHandler> handler = new RequestTestHandler(       \
...
class InvalidURLTestClient : public HoneycombURLRequestClient {
 public:
  ...
  void OnRequestComplete(HoneycombRefPtr<HoneycombURLRequest> client) override {
 ...
 private:
  void RunOnUIThread() {
    ...
    HoneycombURLRequest::Create(request, this, nullptr);
  }
...
TEST(URLRequestTest, BrowserInvalidURL) {
  HoneycombRefPtr<InvalidURLTestClient> client = new InvalidURLTestClient();
  client->RunTest();
}
