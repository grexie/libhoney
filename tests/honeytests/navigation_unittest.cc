...
const honey_transition_type_t kTransitionExplicitLoad =
    static_cast<honey_transition_type_t>(TT_EXPLICIT | TT_DIRECT_LOAD_FLAG);

// TT_FORWARD_BACK_FLAG is added to the original transition flags.
const honey_transition_type_t kTransitionExplicitForwardBack =
    static_cast<honey_transition_type_t>(kTransitionExplicitLoad |
...
class HistoryNavRendererTest : public ClientAppRenderer::Delegate,
 ...
 protected:
  void SendTestResultsIfDone(HoneycombRefPtr<HoneycombBrowser> browser,
                             HoneycombRefPtr<HoneycombFrame> frame) {
  ...
  void SendTestResults(HoneycombRefPtr<HoneycombBrowser> browser,
                       HoneycombRefPtr<HoneycombFrame> frame) {
#if VERBOSE_DEBUGGING
    const NavListItem& item = kHNavList[nav_];
    LOG(INFO) << "render nav=" << nav_ << " " << NavActionString(item.action)
    ...
    HoneycombRefPtr<HoneycombProcessMessage> return_msg =
        HoneycombProcessMessage::Create(kHistoryNavMsg);
    HoneycombRefPtr<HoneycombListValue> args = return_msg->GetArgumentList();
...
class NavigationEntryVisitor : public HoneycombNavigationEntryVisitor {
 public:
  ...
  bool Visit(HoneycombRefPtr<HoneycombNavigationEntry> entry,
    ...
    EXPECT_GT(HoneycombTimeFrom(entry->GetCompletionTime()).GetTimeT(), 0);
...
class HistoryNavTestHandler : public TestHandler {
 public:
  ...
  void RunTest() override {
    ...
    // Create the browser.
    CreateBrowser(HoneycombString(), nullptr, extra_info);

    // Time out the test after a reasonable period of time.
    SetTestTimeout();
  }

  void RunNav(HoneycombRefPtr<HoneycombBrowser> browser) {
  ...
  void RunNextNavIfReady(HoneycombRefPtr<HoneycombBrowser> browser) {
#if VERBOSE_DEBUGGING
  ...
  void OnLoadEnd(HoneycombRefPtr<HoneycombBrowser> browser,
    ...
    HoneycombRefPtr<NavigationEntryVisitor> visitor =
...
TEST(NavigationTest, History) {
  HoneycombRefPtr<HistoryNavTestHandler> handler = new HistoryNavTestHandler();
  handler->ExecuteTest();
...
class HistoryDynamicIFramesNavTestHandler : public TestHandler {
 public:
  ...
  void OnLoadEnd(HoneycombRefPtr<HoneycombBrowser> browser,
    ...
    HoneycombString url = browser->GetMainFrame()->GetURL();
    got_load_end_[nav_].yes();
...
TEST(NavigationTest, HistoryDynamicIFrames) {
  HoneycombRefPtr<HistoryDynamicIFramesNavTestHandler> handler =
...
class RedirectSchemeHandler : public HoneycombResourceHandler {
 public:
  ...
  void GetResponseHeaders(HoneycombRefPtr<HoneycombResponse> response,
    ...
    if (status_ == 302) {
      ...
      HoneycombResponse::HeaderMap headers;
  ...
  void Cancel() override { EXPECT_TRUE(HoneycombCurrentlyOn(TID_IO)); }
...
class RedirectSchemeHandlerFactory : public HoneycombSchemeHandlerFactory {
 public:
...
TEST(NavigationTest, Redirect) {
  HoneycombRegisterSchemeHandlerFactory("https", "tests",
                                  new RedirectSchemeHandlerFactory());
  WaitForIOThread();

  HoneycombRefPtr<RedirectTestHandler> handler = new RedirectTestHandler();
  handler->ExecuteTest();

  HoneycombClearSchemeHandlerFactories();
  WaitForIOThread();
...
TEST(NavigationTest, RedirectDestroy) {
  ...
  HoneycombRefPtr<RedirectDestroyTestHandler> handler =
...
class OrderNavLoadState {
 public:
  ...
  void OnLoadStart(HoneycombRefPtr<HoneycombBrowser> browser, HoneycombRefPtr<HoneycombFrame> frame) {
...
class OrderNavRendererTest : public ClientAppRenderer::Delegate,
 ...
 public:
  ...
  void OnBrowserDestroyed(HoneycombRefPtr<ClientAppRenderer> app,
 ...
 protected:
  ...
  void SendTestResults(HoneycombRefPtr<HoneycombBrowser> browser,
    ...
    // Return the result to the browser process.
    HoneycombRefPtr<HoneycombProcessMessage> return_msg =
        HoneycombProcessMessage::Create(msg_name);
    HoneycombRefPtr<HoneycombListValue> args = return_msg->GetArgumentList();
    EXPECT_TRUE(args.get());
  ...
  HoneycombRefPtr<HoneycombBrowser> browser_main_;
...
class OrderNavTestHandler : public TestHandler {
 public:
  ...
  HoneycombRefPtr<HoneycombDictionaryValue> GetExtraInfo() {
    HoneycombRefPtr<HoneycombDictionaryValue> extra_info = HoneycombDictionaryValue::Create();
  ...
  void ContinueIfReady(HoneycombRefPtr<HoneycombBrowser> browser) {
    if (!got_message_) {
      return;
    }
    ...
    if (!browser->IsPopup()) {
      ...
      browser->GetMainFrame()->ExecuteJavaScript(
          "window.open('" + std::string(KONav2) + "');", HoneycombString(), 0);
    } else {
 ...
 protected:
  ...
  int browser_id_main_;
  int browser_id_popup_;
  HoneycombRefPtr<HoneycombBrowser> browser_popup_;
...
TEST(NavigationTest, Order) {
  HoneycombRefPtr<OrderNavTestHandler> handler = new OrderNavTestHandler();
  handler->ExecuteTest();
  ReleaseAndWaitForDestructor(handler);
}
...
class LoadNavRendererTest : public ClientAppRenderer::Delegate,
 ...
 protected:
  ...
  void SendTestResults(HoneycombRefPtr<HoneycombBrowser> browser,
    ...
    // Return the result to the browser process.
    HoneycombRefPtr<HoneycombProcessMessage> return_msg =
        HoneycombProcessMessage::Create(kLoadNavMsg);
    HoneycombRefPtr<HoneycombListValue> args = return_msg->GetArgumentList();
    EXPECT_TRUE(args.get());
    EXPECT_TRUE(args->SetBool(0, result));
...
class LoadNavTestHandler : public TestHandler {
 public:
  ...
  void ContinueIfReady(HoneycombRefPtr<HoneycombBrowser> browser) {
    ...
    if (url == kLoadNav1) {
      ...
      if (mode_ == LOAD) {
        ...
        honey_mouse_button_type_t button_type =
  ...
  honey_transition_type_t ExpectedOpenURLTransitionType() const {
...
TEST(NavigationTest, LoadSameOriginLoadURL) {
  HoneycombRefPtr<LoadNavTestHandler> handler =
...
TEST(NavigationTest, PopupSimultaneousDifferentUrl) {
  HoneycombRefPtr<PopupSimultaneousTestHandler> handler =
...
class PopupJSWindowOpenTestHandler : public TestHandler {
 public:
  ...
  void RunTestContinue(HoneycombRefPtr<HoneycombRequestContext> request_context) {
    EXPECT_UI_THREAD();

    GrantPopupPermission(request_context, HoneycombString());
 ...
 private:
  ...
  HoneycombRefPtr<HoneycombBrowser> popup1_;
  HoneycombRefPtr<HoneycombBrowser> popup2_;
...
TEST(NavigationTest, PopupJSWindowEmpty) {
  HoneycombRefPtr<PopupJSWindowEmptyTestHandler> handler =
...
TEST(NavigationTest, BrowseAllow) {
  HoneycombRefPtr<BrowseNavTestHandler> handler = new BrowseNavTestHandler(true);
  handler->ExecuteTest();
  ReleaseAndWaitForDestructor(handler);
}
...
TEST(NavigationTest, BrowseDeny) {
  HoneycombRefPtr<BrowseNavTestHandler> handler = new BrowseNavTestHandler(false);
  handler->ExecuteTest();
  ReleaseAndWaitForDestructor(handler);
}
...
TEST(NavigationTest, SamePage) {
  HoneycombRefPtr<SameNavTestHandler> handler = new SameNavTestHandler();
  handler->ExecuteTest();
  ReleaseAndWaitForDestructor(handler);
}
...
class UnstartedSchemeHandler : public HoneycombResourceHandler {
 public:
 ...
 protected:
  HoneycombRefPtr<HoneycombResourceReadCallback> callback_;
...
TEST(NavigationTest, CancelBeforeCommit) {
  HoneycombRefPtr<CancelBeforeNavTestHandler> handler =
...
class StalledSchemeHandler : public HoneycombResourceHandler {
 public:
...
TEST(NavigationTest, CancelAfterCommit) {
  HoneycombRefPtr<CancelAfterNavTestHandler> handler =
...
void SetBrowserExtraInfo(HoneycombRefPtr<HoneycombDictionaryValue> extra_info) {
...
class ExtraInfoNavRendererTest : public ClientAppRenderer::Delegate {
 ...
 protected:
  ...
  void SendTestResults(HoneycombRefPtr<HoneycombBrowser> browser,
    ...
    HoneycombRefPtr<HoneycombProcessMessage> return_msg =
        HoneycombProcessMessage::Create(kExtraInfoNavMsg);
    HoneycombRefPtr<HoneycombListValue> args = return_msg->GetArgumentList();
    EXPECT_TRUE(args.get());
    EXPECT_TRUE(args->SetBool(0, result));
...
class ExtraInfoNavTestHandler : public TestHandler {
 public:
  ...
  bool OnBeforePopup(HoneycombRefPtr<HoneycombBrowser> browser,
    ...
    HoneycombRefPtr<HoneycombDictionaryValue> extra = HoneycombDictionaryValue::Create();
...
TEST(NavigationTest, ExtraInfo) {
  HoneycombRefPtr<ExtraInfoNavTestHandler> handler = new ExtraInfoNavTestHandler();
  handler->ExecuteTest();
  ReleaseAndWaitForDestructor(handler);
}
