...
#ifndef HONEYCOMB_TESTS_HONEYCOMBTESTS_TEST_SERVER_MANAGER_H_
#define HONEYCOMB_TESTS_HONEYCOMBTESTS_TEST_SERVER_MANAGER_H_
#pragma once
...
class Manager : public Runner::Delegate {
 public:
  ...
  // HoneycombRegistration object is destroyed. Registered observers will be executed
  ...
  static HoneycombRefPtr<HoneycombRegistration> AddObserver(Observer* observer,
                                                DoneCallback callback,
                                                bool https_server);

  // Combination of AddObserver() followed by Start().
  static HoneycombRefPtr<HoneycombRegistration> AddObserverAndStart(
      Observer* observer,
 ...
 private:
  ...
  void OnTestServerRequest(HoneycombRefPtr<HoneycombRequest> request,
...
#endif  // HONEYCOMB_TESTS_HONEYCOMBTESTS_TEST_SERVER_MANAGER_H_
