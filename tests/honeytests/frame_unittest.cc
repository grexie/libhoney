...
// 5. If the renderer process does not already exist Honeycomb creates it with
...
class FrameNavExpectations {
 public:
  typedef base::OnceCallback<void(HoneycombRefPtr<HoneycombBrowser>, HoneycombRefPtr<HoneycombFrame>)>
      CompletionCallback;
  ...
  virtual bool OnLoadingStateChange(HoneycombRefPtr<HoneycombBrowser> browser,
                                    bool isLoading) {
    return true;
  }
  virtual bool OnLoadStart(HoneycombRefPtr<HoneycombBrowser> browser,
                           HoneycombRefPtr<HoneycombFrame> frame) {
    return true;
  }
  virtual bool OnLoadEnd(HoneycombRefPtr<HoneycombBrowser> browser,
                         HoneycombRefPtr<HoneycombFrame> frame) {
    return true;
  }
  ...
  // notifications.
  void SignalComplete(HoneycombRefPtr<HoneycombBrowser> browser,
                      HoneycombRefPtr<HoneycombFrame> frame) {
...
class FrameNavExpectationsBrowser : public FrameNavExpectations {
 public:
  ...
  virtual bool OnAfterCreated(HoneycombRefPtr<HoneycombBrowser> browser) {
  ...
  virtual bool GetResourceHandler(HoneycombRefPtr<HoneycombBrowser> browser,
                                  HoneycombRefPtr<HoneycombFrame> frame) {
    EXPECT_TRUE(browser.get());
    EXPECT_TRUE(frame.get());
    return true;
  ...
  virtual bool OnRendererComplete(HoneycombRefPtr<HoneycombBrowser> browser,
                                  HoneycombRefPtr<HoneycombFrame> frame,
                                  int renderer_nav,
 ...
 protected:
  ...
  void SendTestResults(HoneycombRefPtr<HoneycombBrowser> browser,
    ...
    HoneycombRefPtr<HoneycombProcessMessage> return_msg =
        HoneycombProcessMessage::Create(kFrameNavMsg);
    ...
    EXPECT_TRUE(args->SetInt(2, HoneycombInt64GetLow(frame_id)));
    EXPECT_TRUE(args->SetInt(3, HoneycombInt64GetHigh(frame_id)));
...
class FrameNavTestHandler : public TestHandler {
 public:
  ...
  // Will be called via FrameNavExpectations::SignalComplete.
  void RunNextNav(HoneycombRefPtr<HoneycombBrowser> browser, HoneycombRefPtr<HoneycombFrame> frame) {
    // End of the current expectations object.
  ...
  bool OnProcessMessageReceived(HoneycombRefPtr<HoneycombBrowser> browser,
    ...
    if (message->GetName().ToString() == kFrameNavMsg) {
      ...
      const int64_t frame_id = HoneycombInt64Set(args->GetInt(2), args->GetInt(3));
...
#define FRAME_TEST(name, factory_id)         \
  TEST(FrameTest, name) {                    \
    HoneycombRefPtr<FrameNavTestHandler> handler = \
...
class FrameNavExpectationsBrowserSingleNav
 ...
 public:
  ...
  bool OnLoadingStateChange(HoneycombRefPtr<HoneycombBrowser> browser,
  ...
  bool OnLoadStart(HoneycombRefPtr<HoneycombBrowser> browser,
  ...
  bool OnLoadEnd(HoneycombRefPtr<HoneycombBrowser> browser,
                 HoneycombRefPtr<HoneycombFrame> frame) override {
  ...
  bool OnAfterCreated(HoneycombRefPtr<HoneycombBrowser> browser) override {
  ...
  bool GetResourceHandler(HoneycombRefPtr<HoneycombBrowser> browser,
                          HoneycombRefPtr<HoneycombFrame> frame) override {
  ...
  bool OnRendererComplete(HoneycombRefPtr<HoneycombBrowser> browser,
                          HoneycombRefPtr<HoneycombFrame> frame,
                          int renderer_nav,
 ...
 private:
  void SignalCompleteIfDone(HoneycombRefPtr<HoneycombBrowser> browser,
                            HoneycombRefPtr<HoneycombFrame> frame) {
...
bool VerifySingleBrowserFrame(HoneycombRefPtr<HoneycombBrowser> browser,
                              HoneycombRefPtr<HoneycombFrame> frame,
...
bool VerifySingleBrowserFrames(HoneycombRefPtr<HoneycombBrowser> browser,
                               HoneycombRefPtr<HoneycombFrame> frame,
                               const std::string& expected_url) {
  V_DECLARE();
  ...
  HoneycombRefPtr<HoneycombFrame> main_frame = browser->GetMainFrame();
  V_EXPECT_TRUE(VerifySingleBrowserFrame(browser, main_frame, expected_url));

  HoneycombRefPtr<HoneycombFrame> focused_frame = browser->GetFocusedFrame();
...
bool VerifyBrowserIframe(HoneycombRefPtr<HoneycombBrowser> browser,
                         HoneycombRefPtr<HoneycombFrame> frame,
  ...
  HoneycombRefPtr<HoneycombFrame> frame0, frame1, frame2, frame3;
  HoneycombRefPtr<HoneycombFrame> frame0b, frame1b, frame2b, frame3b;
