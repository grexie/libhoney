...
#ifndef HONEYCOMB_TESTS_HONEYCOMBTESTS_TEST_SERVER_OBSERVER_H_
#define HONEYCOMB_TESTS_HONEYCOMBTESTS_TEST_SERVER_OBSERVER_H_
#pragma once
...
#endif  // HONEYCOMB_TESTS_HONEYCOMBTESTS_TEST_SERVER_OBSERVER_H_
