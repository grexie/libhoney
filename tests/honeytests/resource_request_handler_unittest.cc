...
// calls to Cancel.
// This also tests the HoneycombStreamResourceHandler implementation.
class NormalResourceHandler : public HoneycombStreamResourceHandler {
 public:
  NormalResourceHandler(int status_code,
      ...
      : HoneycombStreamResourceHandler(status_code,
                                 status_text,
                                 mime_type,
                                 header_map,
                                 stream),
...
class CallbackResourceHandler : public HoneycombResourceHandler {
 public:
  enum Mode {
    DELAYED_OPEN,
    DELAYED_READ,
  ...
  bool Open(HoneycombRefPtr<HoneycombRequest> request,
    ...
    if (IsDelayedOpen()) {
      ...
      HoneycombPostTask(TID_FILE_USER_VISIBLE,
                  base::BindOnce(&HoneycombCallback::Continue, callback));
...
class IncompleteResourceHandlerOld : public HoneycombResourceHandler {
 public:
  enum TestMode {
...
class IncompleteResourceHandler : public HoneycombResourceHandler {
 public:
  enum TestMode {
    BLOCK_OPEN,
    BLOCK_READ,
...
class BasicResponseTest : public TestHandler {
 public:
  enum TestMode {
    ...
    // Return a HoneycombResourceHandler from GetResourceHandler that continues
    ...
    // Return a HoneycombResourceHandler from GetResourceHandler that continues with
    // a delay by using the callback object.
    DELAYED_REQUEST_HANDLER_OPEN,
    DELAYED_REQUEST_HANDLER_READ,
    DELAYED_REQUEST_HANDLER_ALL,

    // Return a HoneycombResourceHandler from GetResourceHandler that never completes,
    ...
    // Redirect the request using a HoneycombResourceHandler returned from
    // GetResourceHandler.
    REDIRECT_REQUEST_HANDLER,

    // Redirect the request (change the URL) an additional time in
    // OnResourceRedirect after using a HoneycombResourceHandler returned from
 ...
 private:
  ...
  HoneycombRefPtr<HoneycombResourceHandler> GetResource(int status_code,
                                            const HoneycombString& status_text,
                                            const HoneycombString& mime_type,
                                            HoneycombResponse::HeaderMap header_map,
  ...
  HoneycombRefPtr<HoneycombResourceHandler> GetOKResource() {
    return GetResource(200, "OK", "text/html", HoneycombResponse::HeaderMap(),
                       GetResponseBody());
  }

  HoneycombRefPtr<HoneycombResourceHandler> GetRedirectResource(
  ...
  HoneycombRefPtr<HoneycombResourceHandler> GetIncompleteResource() {
  ...
  static void SetCustomHeader(HoneycombRefPtr<HoneycombRequest> request) {
    EXPECT_FALSE(request->IsReadOnly());
    request->SetHeaderByName("X-Custom-Header", "value", false);
  }

  static std::string GetCustomHeader(HoneycombRefPtr<HoneycombRequest> request) {
  ...
  void VerifyState(Callback callback,
                   HoneycombRefPtr<HoneycombRequest> request,
                   HoneycombRefPtr<HoneycombResponse> response) const {
  ...
  void MaybeDestroyTest(bool from_handler) {
    if (!HoneycombCurrentlyOn(TID_UI)) {
      HoneycombPostTask(TID_UI, base::BindOnce(&BasicResponseTest::MaybeDestroyTest,
                                         this, from_handler));
      return;
    }
...
#define BASIC_TEST(name, test_mode, custom, unhandled)            \
  TEST(ResourceRequestHandlerTest, Basic##name) {                 \
    HoneycombRefPtr<BasicResponseTest> handler = new BasicResponseTest( \
...
class SubresourceResponseTest : public RoutingTestHandler {
 ...
 private:
  ...
  HoneycombRefPtr<HoneycombResourceHandler> GetMainResource() {
    return GetResource(200, "OK", "text/html", HoneycombResponse::HeaderMap(),
                       GetMainResponseBody());
  }

  HoneycombRefPtr<HoneycombResourceHandler> GetSubResource() {
    return GetResource(200, "OK", "text/html", HoneycombResponse::HeaderMap(),
                       GetSubResponseBody());
  }

  HoneycombRefPtr<HoneycombResourceHandler> GetOKResource() {
    return GetResource(200, "OK", "text/javascript", HoneycombResponse::HeaderMap(),
                       GetResponseBody());
  }
  ...
  void VerifyFrame(Callback callback, HoneycombRefPtr<HoneycombFrame> frame) const {
    EXPECT_TRUE(frame);
...
#define SUBRESOURCE_TEST(name, test_mode, custom, unhandled, subframe)        \
  TEST(ResourceRequestHandlerTest, Subresource##name) {                       \
    HoneycombRefPtr<SubresourceResponseTest> handler = new SubresourceResponseTest( \
 ...
 public:
  ...
  void RunTest() override {
    ...
    if (via_request_context_handler_) {
      HoneycombRefPtr<HoneycombRequestContextHandler> request_context_handler =
 ...
 private:
  ...
  class ResourceTest {
   public:
    ...
    virtual bool OnBeforeResourceLoad(HoneycombRefPtr<HoneycombBrowser> browser,
                                      HoneycombRefPtr<HoneycombFrame> frame,
                                      HoneycombRefPtr<HoneycombRequest> request) {
    ...
    virtual HoneycombRefPtr<HoneycombResourceHandler> GetResourceHandler(
      ...
      return new HoneycombStreamResourceHandler(200, "OK", "text/javascript",
                                          HoneycombResponse::HeaderMap(), stream);
    }
   ...
   protected:
    virtual void OnResourceReceived(HoneycombRefPtr<HoneycombBrowser> browser,
                                    HoneycombRefPtr<HoneycombFrame> frame,
                                    HoneycombRefPtr<HoneycombRequest> request,
                                    HoneycombRefPtr<HoneycombResponse> response) {
      got_resource_.yes();
    ...
    virtual void OnRetryReceived(HoneycombRefPtr<HoneycombBrowser> browser,
                                 HoneycombRefPtr<HoneycombFrame> frame,
                                 HoneycombRefPtr<HoneycombRequest> request,
                                 HoneycombRefPtr<HoneycombResponse> response) {
  ...
  class UrlResourceTest : public ResourceTest {
   ...
   private:
    void OnResourceReceived(HoneycombRefPtr<HoneycombBrowser> browser,
                            HoneycombRefPtr<HoneycombFrame> frame,
                            HoneycombRefPtr<HoneycombRequest> request,
                            HoneycombRefPtr<HoneycombResponse> response) override {
    ...
    void OnRetryReceived(HoneycombRefPtr<HoneycombBrowser> browser,
                         HoneycombRefPtr<HoneycombFrame> frame,
                         HoneycombRefPtr<HoneycombRequest> request,
                         HoneycombRefPtr<HoneycombResponse> response) override {
  ...
  class HeaderResourceTest : public ResourceTest {
   ...
   private:
    ...
    void OnRetryReceived(HoneycombRefPtr<HoneycombBrowser> browser,
                         ...
                         HoneycombRefPtr<HoneycombResponse> response) override {
      ResourceTest::OnRetryReceived(browser, frame, request, response);
      HoneycombRequest::HeaderMap actual_headers;
      request->GetHeaderMap(actual_headers);
      TestMapEqual(expected_headers_, actual_headers, true);
    }

    HoneycombRequest::HeaderMap expected_headers_;
  };
  ...
  class PostResourceTest : public ResourceTest {
   public:
    ...
    PostResourceTest()
      ...
      HoneycombRefPtr<HoneycombPostDataElement> elem = HoneycombPostDataElement::Create();
      const std::string data("Test Post Data");
      elem->SetToBytes(data.size(), data.c_str());

      expected_post_ = HoneycombPostData::Create();
   ...
   private:
    ...
    void OnRetryReceived(HoneycombRefPtr<HoneycombBrowser> browser,
                         ...
                         HoneycombRefPtr<HoneycombResponse> response) override {
      ResourceTest::OnRetryReceived(browser, frame, request, response);
      HoneycombRefPtr<HoneycombPostData> actual_post = request->GetPostData();
      TestPostDataEqual(expected_post_, actual_post);
    }

    HoneycombRefPtr<HoneycombPostData> expected_post_;
  };

  class RequestContextHandler : public HoneycombRequestContextHandler {
   public:
    explicit RequestContextHandler(
        HoneycombRefPtr<HoneycombResourceRequestHandler> resource_request_handler)
   ...
   private:
    HoneycombRefPtr<HoneycombResourceRequestHandler> resource_request_handler_;

    IMPLEMENT_REFCOUNTING(RequestContextHandler);
    DISALLOW_COPY_AND_ASSIGN(RequestContextHandler);
  };

  class ResourceRequestHandler : public HoneycombResourceRequestHandler {
   public:
  ...
  HoneycombRefPtr<ResourceRequestHandler> resource_request_handler_;
...
TEST(ResourceRequestHandlerTest, RedirectURLViaClient) {
  HoneycombRefPtr<RedirectResponseTest> handler =
  ...
  honey_return_value_t OnBeforeResourceLoad(
    ...
    if (test_mode_ == CANCEL) {
      ...
      if (test_mode_ == CANCEL_NAV) {
        ...
        HoneycombPostTask(TID_UI,
                    base::BindOnce(&HoneycombCallback::Continue, callback.get()));
      } else {
        // Cancel asynchronously.
        HoneycombPostTask(TID_UI,
                    base::BindOnce(&HoneycombCallback::Cancel, callback.get()));
      }
      return RV_CONTINUE_ASYNC;
    }
  }
...
TEST(ResourceRequestHandlerTest, BeforeResourceLoadCancel) {
  HoneycombRefPtr<BeforeResourceLoadTest> handler =
...
class ResponseFilterTestBase : public HoneycombResponseFilter {
 public:
  ...
  virtual void VerifyOutput(honey_urlrequest_status_t status,
                            int64_t received_content_length,
...
class ResponseFilterPassThru : public ResponseFilterTestBase {
 public:
  ...
  void VerifyOutput(honey_urlrequest_status_t status,
                    int64_t received_content_length,
...
class ResponseFilterTestHandler : public TestHandler {
 public:
  explicit ResponseFilterTestHandler(
      HoneycombRefPtr<ResponseFilterTestBase> response_filter)
 ...
 private:
  ...
  void GetOutputContent(HoneycombRefPtr<HoneycombFrame> frame) {
    class StringVisitor : public HoneycombStringVisitor {
     public:
  ...
  HoneycombRefPtr<ResponseFilterTestBase> response_filter_;
...
TEST(ResourceRequestHandlerTest, FilterPassThruReadAll) {
  HoneycombRefPtr<ResponseFilterTestHandler> handler =
...
void RegisterResourceRequestHandlerCustomSchemes(
  ...
  registrar->AddCustomScheme(
      "rrhcustom", HONEYCOMB_SCHEME_OPTION_STANDARD | HONEYCOMB_SCHEME_OPTION_CORS_ENABLED);
}
