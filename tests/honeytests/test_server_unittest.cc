...
class TestServerHandler : public HoneycombTestServerHandler {
 public:
  // HTTP test handler.
  ...
  class HttpRequestHandler {
   public:
    ...
    virtual bool HandleRequest(
        ...
        HoneycombRefPtr<HoneycombTestServerConnection> connection) = 0;
  ...
  void CreateServer(bool https_server) {
    ...
    server_ = HoneycombTestServer::CreateAndStart(/*port=*/0, https_server,
                                            HONEYCOMB_TEST_CERT_OK_DOMAIN, this);
 ...
 private:
  ...
  bool VerifyRequest(HoneycombRefPtr<HoneycombRequest> request) const {
    V_DECLARE();
...
struct HttpServerResponse {
  ...
  int response_code;
  HoneycombRequest::HeaderMap extra_headers;
};

void SendHttpServerResponse(HoneycombRefPtr<HoneycombTestServerConnection> connection,
...
std::string GetHeaderValue(const HoneycombRequest::HeaderMap& header_map,
  ...
  HoneycombRequest::HeaderMap::const_iterator it = header_map.find(header_name);
...
class StaticHttpServerRequestHandler
 ...
 public:
  ...
  bool HandleRequest(HoneycombRefPtr<HoneycombTestServer> server,
                     HoneycombRefPtr<HoneycombRequest> request,
                     HoneycombRefPtr<HoneycombTestServerConnection> connection) override {
...
TEST(TestServerTest, HttpSingle200) {
  HoneycombRefPtr<HttpTestRunner> runner =
