...
class OtherServerObserver : public test_server::ObserverHelper {
 public:
  ...
  using RequestCallback =
      base::RepeatingCallback<bool(HoneycombRefPtr<HoneycombRequest> request,
...
class CertificateErrorTest : public TestHandler, public HoneycombTestServerHandler {
 public:
  ...
  CertificateErrorTest(
      honey_test_cert_type_t cert_type,
  ...
  bool OnOtherServerRequest(HoneycombRefPtr<HoneycombRequest> request,
                            const ResponseCallback& response_callback) {
    EXPECT_UI_THREAD();
 ...
 private:
  void HandleHttpsRequest(HoneycombRefPtr<HoneycombRequest> request,
  ...
  void StartHttpsServer() {
    ...
    server_ = HoneycombTestServer::CreateAndStart(/*port=*/0, /*https_server=*/true,
                                            cert_type_, this);
  ...
  void DoCreateBrowserContinue(HoneycombRefPtr<HoneycombRequestContext> request_context) {
    EXPECT_UI_THREAD();
  ...
  const honey_test_cert_type_t cert_type_;
...
TEST(CertificateErrorTest, DirectNoError) {
  HoneycombRefPtr<CertificateErrorTest> handler = new CertificateErrorTest(
      /*cert_type=*/HONEYCOMB_TEST_CERT_OK_DOMAIN, /*expect_load_success=*/true,
...
TEST(CertificateErrorTest, DirectExpired) {
  HoneycombRefPtr<CertificateErrorTest> handler = new CertificateErrorTest(
      /*cert_type=*/HONEYCOMB_TEST_CERT_EXPIRED, /*expect_load_success=*/false,
...
class DirectMismatchedTest : public CertificateErrorTest {
 public:
  DirectMismatchedTest(bool continue_invalid_certificate)
      : CertificateErrorTest(
            /*cert_type=*/HONEYCOMB_TEST_CERT_OK_DOMAIN,
...
TEST(CertificateErrorTest, DirectMismatchedCancel) {
  HoneycombRefPtr<DirectMismatchedTest> handler =
...
TEST(CertificateErrorTest, RedirectMismatchedFromHttpsResourceCancel) {
  HoneycombRefPtr<RedirectMismatchedFromHandlerTest> handler =
...
class RedirectMismatchedFromServerTest : public CertificateErrorTest {
 public:
  ...
  void HandleOtherServerRequest(
    ...
    // Redirect to the end URL.
    auto response = HoneycombResponse::Create();
...
TEST(CertificateErrorTest, RedirectMismatchedFromHttpsServerCancel) {
  HoneycombRefPtr<RedirectMismatchedFromServerTest> handler =
