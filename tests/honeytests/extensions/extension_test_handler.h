...
#ifndef HONEYCOMB_TESTS_HONEYCOMBTESTS_EXTENSIONS_EXTENSION_TEST_HANDLER_H_
#define HONEYCOMB_TESTS_HONEYCOMBTESTS_EXTENSIONS_EXTENSION_TEST_HANDLER_H_
#pragma once
...
class ExtensionTestHandler : public RoutingTestHandler,
 ...
 public:
  ...
  HoneycombRefPtr<HoneycombRequestContext> request_context() const {
    return request_context_;
  }
  HoneycombRefPtr<HoneycombRequestContext> loader_request_context() const {
 ...
 protected:
  ...
  static HoneycombRefPtr<HoneycombDictionaryValue> CreateDefaultManifest(
  ...
  static void VerifyExtensionInContext(HoneycombRefPtr<HoneycombExtension> extension,
  ...
  void UnloadExtension(HoneycombRefPtr<HoneycombExtension> extension);
  ...
  virtual bool OnMessage(HoneycombRefPtr<HoneycombBrowser> browser,
 ...
 private:
  ...
  HoneycombScopedTempDir request_context_temp_dir_;
  ...
  HoneycombRefPtr<HoneycombRequestContext> loader_request_context_;
...
#define EXTENSION_TEST(name, test_class, rc_type)                        \
  TEST(ExtensionTest, name) {                                            \
    HoneycombRefPtr<test_class> handler = new test_class(                      \
...
#endif  // HONEYCOMB_TESTS_HONEYCOMBTESTS_EXTENSIONS_EXTENSION_TEST_HANDLER_H_
