...
class TabsTestHandler : public ExtensionTestHandler {
 public:
  ...
  void OnExtensionUnloaded(HoneycombRefPtr<HoneycombExtension> extension) override {
    ...
    HoneycombPostTask(TID_UI, base::BindOnce(&TabsTestHandler::DestroyTest, this));
  }
 ...
 protected:
  ...
  virtual HoneycombRefPtr<HoneycombDictionaryValue> CreateManifest() const {
  ...
  virtual void TriggerDestroyTest() {
    // Execute asynchronously so call stacks have a chance to unwind.
    HoneycombPostTask(TID_UI, base::BindOnce(&TabsTestHandler::UnloadExtension, this,
                                       extension_));
  }

  HoneycombRefPtr<HoneycombExtension> extension() const { return extension_; }
  std::string extension_url() const { return extension_url_; }
  HoneycombRefPtr<HoneycombBrowser> main_browser() const { return main_browser_; }
  HoneycombRefPtr<HoneycombBrowser> extension_browser() const { return extension_browser_; }
 ...
 private:
  ...
  HoneycombRefPtr<HoneycombBrowser> main_browser_;
...
class CreateTestHandler : public TabsTestHandler {
 ...
 protected:
  ...
  bool OnMessage(HoneycombRefPtr<HoneycombBrowser> browser,
    ...
    if (message.find(kTabCallbackMessage) != std::string::npos) {
      ...
      HoneycombRefPtr<HoneycombValue> obj = HoneycombParseJSON(json_str, JSON_PARSER_RFC);
      EXPECT_TRUE(obj);
      EXPECT_EQ(VTYPE_DICTIONARY, obj->GetType());
      HoneycombRefPtr<HoneycombDictionaryValue> dict = obj->GetDictionary();
 ...
 private:
  ...
  HoneycombRefPtr<HoneycombBrowser> created_browser_;
