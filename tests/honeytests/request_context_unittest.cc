...
TEST(RequestContextTest, BasicGetGlobal) {
  HoneycombRefPtr<HoneycombRequestContext> context1 = HoneycombRequestContext::GetGlobalContext();
  ...
  HoneycombRefPtr<HoneycombRequestContext> context2 = HoneycombRequestContext::GetGlobalContext();
...
TEST(RequestContextTest, BasicCreate) {
  ...
  HoneycombRefPtr<HoneycombRequestContextHandler> handler = new Handler();

  HoneycombRequestContextSettings settings;

  HoneycombRefPtr<HoneycombRequestContext> context1 =
      HoneycombRequestContext::CreateContext(settings, handler.get());
  EXPECT_TRUE(context1.get());
  ...
  HoneycombRefPtr<HoneycombRequestContext> context3 = HoneycombRequestContext::GetGlobalContext();
...
TEST(RequestContextTest, BasicCreateSharedGlobal) {
  ...
  HoneycombRefPtr<HoneycombRequestContext> context2 =
      HoneycombRequestContext::CreateContext(context1, nullptr);
  EXPECT_TRUE(context2.get());
  EXPECT_TRUE(context2->IsGlobal());
  EXPECT_TRUE(context2->IsSame(context2));
  EXPECT_TRUE(context2->IsSame(context1));
...
TEST(RequestContextTest, BasicCreateSharedOnDisk) {
  ...
  HoneycombRefPtr<HoneycombRequestContext> context3 =
      HoneycombRequestContext::CreateContext(context2, nullptr);
  EXPECT_TRUE(context3.get());
  ...
  HoneycombRefPtr<HoneycombRequestContext> context4 =
      HoneycombRequestContext::CreateContext(context1, nullptr);
...
class PopupTestHandler : public TestHandler {
 ...
 protected:
  void LaunchPopup(HoneycombRefPtr<HoneycombBrowser> browser) {
    if (mode_ == MODE_WINDOW_OPEN) {
...
TEST(RequestContextTest, PopupBasicWindowOpenSameOrigin) {
  HoneycombRefPtr<PopupTestHandler> handler =
 ...
 public:
  ...
  void RunTestContinue(HoneycombRefPtr<HoneycombRequestContext> request_context) {
    ...
    if (request_context) {
      ...
      GrantPopupPermission(HoneycombRequestContext::GetGlobalContext(),
                           kPopupNavPageUrl);
    }
...
class MethodTestHandler : public TestHandler {
 public:
  ...
  class CompletionCallback : public HoneycombCompletionCallback,
                             public HoneycombResolveCallback {
   public:
  ...
  void OnLoadEnd(HoneycombRefPtr<HoneycombBrowser> browser,
    ...
    HoneycombRefPtr<HoneycombRequestContext> context =
        browser->GetHost()->GetRequestContext();
    HoneycombRefPtr<CompletionCallback> callback =
  ...
  void OnCompleteCallback(HoneycombRefPtr<HoneycombBrowser> browser) {
    EXPECT_UI_THREAD();
...
// Test HoneycombRequestContext::ClearCertificateExceptions with the global
// context.
TEST(RequestContextTest, ClearCertificateExceptionsGlobal) {
  HoneycombRefPtr<MethodTestHandler> handler = new MethodTestHandler(
      true, MethodTestHandler::METHOD_CLEAR_CERTIFICATE_EXCEPTIONS);
  handler->ExecuteTest();
  ReleaseAndWaitForDestructor(handler);
}

// Test HoneycombRequestContext::ClearCertificateExceptions with a custom
// context.
...
// Test HoneycombRequestContext::CloseAllConnections with the global
// context.
...
// Test HoneycombRequestContext::CloseAllConnections with a custom context.
...
// Test HoneycombRequestContext::ResolveHost with the global context.
TEST(RequestContextTest, ResolveHostGlobal) {
  HoneycombRefPtr<MethodTestHandler> handler =
      new MethodTestHandler(true, MethodTestHandler::METHOD_RESOLVE_HOST);
  handler->ExecuteTest();
  ReleaseAndWaitForDestructor(handler);
}

// Test HoneycombRequestContext::ResolveHost with a custom context.
