...
HoneycombRefPtr<HoneycombSharedProcessMessageBuilder> CreateTestBuilder() {
  auto builder = HoneycombSharedProcessMessageBuilder::Create(kSharedMessageName,
                                                        sizeof(TestData));
...
TEST(SharedProcessMessageTest, CopyingIsNotSupportedBySharedMessage) {
  auto builder = HoneycombSharedProcessMessageBuilder::Create(kSharedMessageName,
                                                        sizeof(TestData));
  HoneycombRefPtr<HoneycombProcessMessage> message = builder->Build();
  HoneycombRefPtr<HoneycombProcessMessage> message_copy = message->Copy();
...
TEST(SharedProcessMessageTest, WrittenValuesVisibleInOtherRegion) {
  HoneycombRefPtr<HoneycombSharedMemoryRegion> read_region;
  HoneycombRefPtr<HoneycombSharedMemoryRegion> write_region;
  {
    auto builder = CreateTestBuilder();
    auto message = builder->Build();
