...
#ifndef HONEYCOMB_LIBHONEYCOMB_DLL_WRAPPER_HONEYCOMB_BROWSER_INFO_MAP_H_
#define HONEYCOMB_LIBHONEYCOMB_DLL_WRAPPER_HONEYCOMB_BROWSER_INFO_MAP_H_
#pragma once
...
// Default traits for HoneycombBrowserInfoMap. Override to provide different object
// destruction behavior.
template <typename ObjectType>
struct DefaultHoneycombBrowserInfoMapTraits {
...
template <typename IdType,
          typename ObjectType,
          typename Traits = DefaultHoneycombBrowserInfoMapTraits<ObjectType>>
class HoneycombBrowserInfoMap {
 public:
  ...
  HoneycombBrowserInfoMap() = default;

  HoneycombBrowserInfoMap(const HoneycombBrowserInfoMap&) = delete;
  HoneycombBrowserInfoMap& operator=(const HoneycombBrowserInfoMap&) = delete;

  ~HoneycombBrowserInfoMap() { clear(); }
...
#endif  // HONEYCOMB_LIBHONEYCOMB_DLL_WRAPPER_HONEYCOMB_BROWSER_INFO_MAP_H_
