...
#ifndef HONEYCOMB_LIBHONEYCOMB_DLL_CPPTOC_REQUEST_CONTEXT_CPPTOC_H_
#define HONEYCOMB_LIBHONEYCOMB_DLL_CPPTOC_REQUEST_CONTEXT_CPPTOC_H_
#pragma once
...
class HoneycombRequestContextCppToC
    : public HoneycombCppToCRefCounted<HoneycombRequestContextCppToC,
                                 HoneycombRequestContext,
                                 honey_request_context_t> {
 public:
  HoneycombRequestContextCppToC();
  virtual ~HoneycombRequestContextCppToC();
};

#endif  // HONEYCOMB_LIBHONEYCOMB_DLL_CPPTOC_REQUEST_CONTEXT_CPPTOC_H_
