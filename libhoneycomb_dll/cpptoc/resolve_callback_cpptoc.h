...
#ifndef HONEYCOMB_LIBHONEYCOMB_DLL_CPPTOC_RESOLVE_CALLBACK_CPPTOC_H_
#define HONEYCOMB_LIBHONEYCOMB_DLL_CPPTOC_RESOLVE_CALLBACK_CPPTOC_H_
#pragma once
...
class HoneycombResolveCallbackCppToC
    : public HoneycombCppToCRefCounted<HoneycombResolveCallbackCppToC,
                                 HoneycombResolveCallback,
                                 honey_resolve_callback_t> {
 public:
  HoneycombResolveCallbackCppToC();
  virtual ~HoneycombResolveCallbackCppToC();
};

#endif  // HONEYCOMB_LIBHONEYCOMB_DLL_CPPTOC_RESOLVE_CALLBACK_CPPTOC_H_
