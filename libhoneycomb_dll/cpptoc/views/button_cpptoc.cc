...
button_as_label_button(struct _honey_button_t* self) {
  ...
  HoneycombRefPtr<HoneycombLabelButton> _retval =
      HoneycombButtonCppToC::Get(self)->AsLabelButton();

  // Return type: refptr_same
  return HoneycombLabelButtonCppToC::Wrap(_retval);
}

void HONEYCOMB_CALLBACK button_set_state(struct _honey_button_t* self,
  ...
  // Execute
  HoneycombButtonCppToC::Get(self)->SetState(state);
}

honey_button_state_t HONEYCOMB_CALLBACK button_get_state(struct _honey_button_t* self) {
  shutdown_checker::AssertNotShutdown();
  ...
  // Execute
  honey_button_state_t _retval = HoneycombButtonCppToC::Get(self)->GetState();

  // Return type: simple
  return _retval;
}

void HONEYCOMB_CALLBACK button_set_ink_drop_enabled(struct _honey_button_t* self,
                                              int enabled) {
  shutdown_checker::AssertNotShutdown();
  ...
  // Execute
  HoneycombButtonCppToC::Get(self)->SetInkDropEnabled(enabled ? true : false);
}

void HONEYCOMB_CALLBACK button_set_tooltip_text(struct _honey_button_t* self,
  ...
  // Execute
  HoneycombButtonCppToC::Get(self)->SetTooltipText(HoneycombString(tooltip_text));
}

void HONEYCOMB_CALLBACK button_set_accessible_name(struct _honey_button_t* self,
  ...
  // Execute
  HoneycombButtonCppToC::Get(self)->SetAccessibleName(HoneycombString(name));
}

honey_browser_view_t* HONEYCOMB_CALLBACK
button_as_browser_view(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
  ...
  HoneycombRefPtr<HoneycombBrowserView> _retval =
      HoneycombButtonCppToC::Get(reinterpret_cast<honey_button_t*>(self))
          ->AsBrowserView();
...
honey_button_t* HONEYCOMB_CALLBACK button_as_button(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
  ...
  HoneycombRefPtr<HoneycombButton> _retval =
      HoneycombButtonCppToC::Get(reinterpret_cast<honey_button_t*>(self))->AsButton();

  // Return type: refptr_same
  return HoneycombButtonCppToC::Wrap(_retval);
}

honey_panel_t* HONEYCOMB_CALLBACK button_as_panel(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
  ...
  HoneycombRefPtr<HoneycombPanel> _retval =
      HoneycombButtonCppToC::Get(reinterpret_cast<honey_button_t*>(self))->AsPanel();
...
button_as_scroll_view(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
...
honey_textfield_t* HONEYCOMB_CALLBACK button_as_textfield(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
...
button_get_type_string(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
...
honey_string_userfree_t HONEYCOMB_CALLBACK button_to_string(struct _honey_view_t* self,
...
int HONEYCOMB_CALLBACK button_is_valid(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
  ...
  // Execute
  bool _retval =
      HoneycombButtonCppToC::Get(reinterpret_cast<honey_button_t*>(self))->IsValid();

  // Return type: bool
  return _retval;
}

int HONEYCOMB_CALLBACK button_is_attached(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
  ...
  // Execute
  bool _retval =
      HoneycombButtonCppToC::Get(reinterpret_cast<honey_button_t*>(self))->IsAttached();

  // Return type: bool
  return _retval;
}

int HONEYCOMB_CALLBACK button_is_same(struct _honey_view_t* self,
  ...
  // Execute
  bool _retval = HoneycombButtonCppToC::Get(reinterpret_cast<honey_button_t*>(self))
...
button_get_delegate(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
...
struct _honey_window_t* HONEYCOMB_CALLBACK button_get_window(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
  ...
  HoneycombRefPtr<HoneycombWindow> _retval =
      HoneycombButtonCppToC::Get(reinterpret_cast<honey_button_t*>(self))->GetWindow();

  // Return type: refptr_same
  return HoneycombWindowCppToC::Wrap(_retval);
}

int HONEYCOMB_CALLBACK button_get_id(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
  ...
  // Execute
  int _retval =
      HoneycombButtonCppToC::Get(reinterpret_cast<honey_button_t*>(self))->GetID();

  // Return type: simple
  return _retval;
}

void HONEYCOMB_CALLBACK button_set_id(struct _honey_view_t* self, int id) {
  shutdown_checker::AssertNotShutdown();
  ...
  // Execute
  HoneycombButtonCppToC::Get(reinterpret_cast<honey_button_t*>(self))->SetID(id);
}

int HONEYCOMB_CALLBACK button_get_group_id(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
  ...
  // Execute
  int _retval =
      HoneycombButtonCppToC::Get(reinterpret_cast<honey_button_t*>(self))->GetGroupID();

  // Return type: simple
  return _retval;
}

void HONEYCOMB_CALLBACK button_set_group_id(struct _honey_view_t* self, int group_id) {
  shutdown_checker::AssertNotShutdown();
...
button_get_parent_view(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
...
struct _honey_view_t* HONEYCOMB_CALLBACK
button_get_view_for_id(struct _honey_view_t* self, int id) {
  shutdown_checker::AssertNotShutdown();
...
void HONEYCOMB_CALLBACK button_set_bounds(struct _honey_view_t* self,
...
honey_rect_t HONEYCOMB_CALLBACK button_get_bounds(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
  ...
  honey_rect_t _retval =
      HoneycombButtonCppToC::Get(reinterpret_cast<honey_button_t*>(self))->GetBounds();

  // Return type: simple
  return _retval;
}

honey_rect_t HONEYCOMB_CALLBACK button_get_bounds_in_screen(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
...
void HONEYCOMB_CALLBACK button_set_size(struct _honey_view_t* self,
  ...
  // Execute
  HoneycombButtonCppToC::Get(reinterpret_cast<honey_button_t*>(self))->SetSize(sizeVal);
}

honey_size_t HONEYCOMB_CALLBACK button_get_size(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
  ...
  honey_size_t _retval =
      HoneycombButtonCppToC::Get(reinterpret_cast<honey_button_t*>(self))->GetSize();

  // Return type: simple
  return _retval;
}

void HONEYCOMB_CALLBACK button_set_position(struct _honey_view_t* self,
...
honey_point_t HONEYCOMB_CALLBACK button_get_position(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
...
void HONEYCOMB_CALLBACK button_set_insets(struct _honey_view_t* self,
...
honey_insets_t HONEYCOMB_CALLBACK button_get_insets(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
  ...
  honey_insets_t _retval =
      HoneycombButtonCppToC::Get(reinterpret_cast<honey_button_t*>(self))->GetInsets();

  // Return type: simple
  return _retval;
}

honey_size_t HONEYCOMB_CALLBACK button_get_preferred_size(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
...
void HONEYCOMB_CALLBACK button_size_to_preferred_size(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
...
honey_size_t HONEYCOMB_CALLBACK button_get_minimum_size(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
...
honey_size_t HONEYCOMB_CALLBACK button_get_maximum_size(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
...
int HONEYCOMB_CALLBACK button_get_height_for_width(struct _honey_view_t* self,
                                             int width) {
  shutdown_checker::AssertNotShutdown();
  ...
  // Execute
  int _retval = HoneycombButtonCppToC::Get(reinterpret_cast<honey_button_t*>(self))
...
void HONEYCOMB_CALLBACK button_invalidate_layout(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
...
void HONEYCOMB_CALLBACK button_set_visible(struct _honey_view_t* self, int visible) {
  shutdown_checker::AssertNotShutdown();
...
int HONEYCOMB_CALLBACK button_is_visible(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
  ...
  // Execute
  bool _retval =
      HoneycombButtonCppToC::Get(reinterpret_cast<honey_button_t*>(self))->IsVisible();

  // Return type: bool
  return _retval;
}

int HONEYCOMB_CALLBACK button_is_drawn(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
  ...
  // Execute
  bool _retval =
      HoneycombButtonCppToC::Get(reinterpret_cast<honey_button_t*>(self))->IsDrawn();

  // Return type: bool
  return _retval;
}

void HONEYCOMB_CALLBACK button_set_enabled(struct _honey_view_t* self, int enabled) {
  shutdown_checker::AssertNotShutdown();
...
int HONEYCOMB_CALLBACK button_is_enabled(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
  ...
  // Execute
  bool _retval =
      HoneycombButtonCppToC::Get(reinterpret_cast<honey_button_t*>(self))->IsEnabled();

  // Return type: bool
  return _retval;
}

void HONEYCOMB_CALLBACK button_set_focusable(struct _honey_view_t* self,
                                       int focusable) {
  shutdown_checker::AssertNotShutdown();
...
int HONEYCOMB_CALLBACK button_is_focusable(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
...
int HONEYCOMB_CALLBACK button_is_accessibility_focusable(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
...
void HONEYCOMB_CALLBACK button_request_focus(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
  ...
  // Execute
  HoneycombButtonCppToC::Get(reinterpret_cast<honey_button_t*>(self))->RequestFocus();
}

void HONEYCOMB_CALLBACK button_set_background_color(struct _honey_view_t* self,
                                              honey_color_t color) {
  shutdown_checker::AssertNotShutdown();
...
honey_color_t HONEYCOMB_CALLBACK button_get_background_color(struct _honey_view_t* self) {
  shutdown_checker::AssertNotShutdown();
...
int HONEYCOMB_CALLBACK button_convert_point_to_screen(struct _honey_view_t* self,
                                                honey_point_t* point) {
  shutdown_checker::AssertNotShutdown();
...
int HONEYCOMB_CALLBACK button_convert_point_from_screen(struct _honey_view_t* self,
                                                  honey_point_t* point) {
  shutdown_checker::AssertNotShutdown();
...
int HONEYCOMB_CALLBACK button_convert_point_to_window(struct _honey_view_t* self,
                                                honey_point_t* point) {
  shutdown_checker::AssertNotShutdown();
...
int HONEYCOMB_CALLBACK button_convert_point_from_window(struct _honey_view_t* self,
                                                  honey_point_t* point) {
  shutdown_checker::AssertNotShutdown();
...
int HONEYCOMB_CALLBACK button_convert_point_to_view(struct _honey_view_t* self,
...
int HONEYCOMB_CALLBACK button_convert_point_from_view(struct _honey_view_t* self,
                                                struct _honey_view_t* view,
                                                honey_point_t* point) {
  shutdown_checker::AssertNotShutdown();
...
HoneycombButtonCppToC::HoneycombButtonCppToC() {
...
template <>
HoneycombRefPtr<HoneycombButton>
HoneycombCppToCRefCounted<HoneycombButtonCppToC, HoneycombButton, honey_button_t>::UnwrapDerived(
...
template <>
HoneycombWrapperType HoneycombCppToCRefCounted<HoneycombButtonCppToC, HoneycombButton, honey_button_t>::
