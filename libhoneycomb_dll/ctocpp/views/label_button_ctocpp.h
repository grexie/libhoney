...
#ifndef HONEYCOMB_LIBHONEYCOMB_DLL_CTOCPP_VIEWS_LABEL_BUTTON_CTOCPP_H_
#define HONEYCOMB_LIBHONEYCOMB_DLL_CTOCPP_VIEWS_LABEL_BUTTON_CTOCPP_H_
#pragma once
...
class HoneycombLabelButtonCToCpp : public HoneycombCToCppRefCounted<HoneycombLabelButtonCToCpp,
                                                        HoneycombLabelButton,
                                                        honey_label_button_t> {
 public:
  HoneycombLabelButtonCToCpp();
  virtual ~HoneycombLabelButtonCToCpp();
...
#endif  // HONEYCOMB_LIBHONEYCOMB_DLL_CTOCPP_VIEWS_LABEL_BUTTON_CTOCPP_H_
