...
#ifndef HONEYCOMB_LIBHONEYCOMB_DLL_CTOCPP_VIEWS_VIEW_CTOCPP_H_
#define HONEYCOMB_LIBHONEYCOMB_DLL_CTOCPP_VIEWS_VIEW_CTOCPP_H_
#pragma once
...
class HoneycombViewCToCpp
    : public HoneycombCToCppRefCounted<HoneycombViewCToCpp, HoneycombView, honey_view_t> {
 public:
  HoneycombViewCToCpp();
  virtual ~HoneycombViewCToCpp();
...
#endif  // HONEYCOMB_LIBHONEYCOMB_DLL_CTOCPP_VIEWS_VIEW_CTOCPP_H_
