...
#ifndef HONEYCOMB_LIBHONEYCOMB_DLL_CTOCPP_VIEWS_PANEL_DELEGATE_CTOCPP_H_
#define HONEYCOMB_LIBHONEYCOMB_DLL_CTOCPP_VIEWS_PANEL_DELEGATE_CTOCPP_H_
#pragma once
...
class HoneycombPanelDelegateCToCpp
    : public HoneycombCToCppRefCounted<HoneycombPanelDelegateCToCpp,
                                 HoneycombPanelDelegate,
                                 honey_panel_delegate_t> {
 public:
  HoneycombPanelDelegateCToCpp();
  virtual ~HoneycombPanelDelegateCToCpp();
...
#endif  // HONEYCOMB_LIBHONEYCOMB_DLL_CTOCPP_VIEWS_PANEL_DELEGATE_CTOCPP_H_
