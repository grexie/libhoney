...
int honey_execute_process(const honey_main_args_t* args,
  ...
  return g_libhoney_pointers.honey_execute_process(args, application,
...
int honey_create_temp_directory_in_directory(const honey_string_t* base_dir,
  ...
  return g_libhoney_pointers.honey_create_temp_directory_in_directory(
      base_dir, prefix, new_dir);
}

NO_SANITIZE("cfi-icall") int honey_directory_exists(const honey_string_t* path) {
  return g_libhoney_pointers.honey_directory_exists(path);
}

NO_SANITIZE("cfi-icall")
int honey_delete_file(const honey_string_t* path, int recursive) {
  return g_libhoney_pointers.honey_delete_file(path, recursive);
}
...
int honey_zip_directory(const honey_string_t* src_dir,
  ...
  return g_libhoney_pointers.honey_zip_directory(src_dir, dest_file,
                                             include_hidden_files);
}

NO_SANITIZE("cfi-icall") void honey_load_crlsets_file(const honey_string_t* path) {
  g_libhoney_pointers.honey_load_crlsets_file(path);
}

NO_SANITIZE("cfi-icall") int honey_is_rtl() {
  return g_libhoney_pointers.honey_is_rtl();
}
...
int honey_add_cross_origin_whitelist_entry(const honey_string_t* source_origin,
  ...
  return g_libhoney_pointers.honey_add_cross_origin_whitelist_entry(
...
int honey_remove_cross_origin_whitelist_entry(const honey_string_t* source_origin,
                                            ...
                                            const honey_string_t* target_domain,
                                            int allow_target_subdomains) {
  return g_libhoney_pointers.honey_remove_cross_origin_whitelist_entry(
      source_origin, target_protocol, target_domain, allow_target_subdomains);
}

NO_SANITIZE("cfi-icall") int honey_clear_cross_origin_whitelist() {
  return g_libhoney_pointers.honey_clear_cross_origin_whitelist();
}
...
honey_string_userfree_t honey_uridecode(const honey_string_t* text,
  ...
  return g_libhoney_pointers.honey_uridecode(text, convert_to_utf8, unescape_rule);
}

NO_SANITIZE("cfi-icall")
struct _honey_value_t* honey_parse_json(const honey_string_t* json_string,
                                    honey_json_parser_options_t options) {
  return g_libhoney_pointers.honey_parse_json(json_string, options);
}
...
struct _honey_value_t* honey_parse_json_buffer(const void* json,
                                           size_t json_size,
                                           honey_json_parser_options_t options) {
  return g_libhoney_pointers.honey_parse_json_buffer(json, json_size, options);
}
...
struct _honey_value_t* honey_parse_jsonand_return_error(
  ...
  return g_libhoney_pointers.honey_parse_jsonand_return_error(json_string, options,
                                                          error_msg_out);
}
...
honey_string_userfree_t honey_write_json(struct _honey_value_t* node,
  ...
  return g_libhoney_pointers.honey_write_json(node, options);
}

NO_SANITIZE("cfi-icall")
int honey_get_path(honey_path_key_t key, honey_string_t* path) {
  return g_libhoney_pointers.honey_get_path(key, path);
}

NO_SANITIZE("cfi-icall")
int honey_launch_process(struct _honey_command_line_t* command_line) {
  return g_libhoney_pointers.honey_launch_process(command_line);
}
...
int honey_register_scheme_handler_factory(
  ...
  return g_libhoney_pointers.honey_register_scheme_handler_factory(
      scheme_name, domain_name, factory);
}

NO_SANITIZE("cfi-icall") int honey_clear_scheme_handler_factories() {
  return g_libhoney_pointers.honey_clear_scheme_handler_factories();
}

NO_SANITIZE("cfi-icall")
int honey_is_cert_status_error(honey_cert_status_t status) {
  return g_libhoney_pointers.honey_is_cert_status_error(status);
}

NO_SANITIZE("cfi-icall") int honey_currently_on(honey_thread_id_t threadId) {
  return g_libhoney_pointers.honey_currently_on(threadId);
}

NO_SANITIZE("cfi-icall")
int honey_post_task(honey_thread_id_t threadId, struct _honey_task_t* task) {
  return g_libhoney_pointers.honey_post_task(threadId, task);
}
...
int honey_post_delayed_task(honey_thread_id_t threadId,
                          ...
                          int64_t delay_ms) {
  return g_libhoney_pointers.honey_post_delayed_task(threadId, task, delay_ms);
}

NO_SANITIZE("cfi-icall")
int honey_begin_tracing(const honey_string_t* categories,
                      struct _honey_completion_callback_t* callback) {
  return g_libhoney_pointers.honey_begin_tracing(categories, callback);
}

NO_SANITIZE("cfi-icall")
int honey_end_tracing(const honey_string_t* tracing_file,
                    struct _honey_end_tracing_callback_t* callback) {
  return g_libhoney_pointers.honey_end_tracing(tracing_file, callback);
}

NO_SANITIZE("cfi-icall") int64_t honey_now_from_system_trace_time() {
  return g_libhoney_pointers.honey_now_from_system_trace_time();
}
...
int honey_register_extension(const honey_string_t* extension_name,
  ...
  return g_libhoney_pointers.honey_register_extension(extension_name,
...
void honey_execute_java_script_with_user_gesture_for_tests(
  ...
  g_libhoney_pointers.honey_execute_java_script_with_user_gesture_for_tests(
      frame, javascript);
}

NO_SANITIZE("cfi-icall")
void honey_set_data_directory_for_tests(const honey_string_t* dir) {
  g_libhoney_pointers.honey_set_data_directory_for_tests(dir);
}
...
int honey_browser_host_create_browser(
  ...
  return g_libhoney_pointers.honey_browser_host_create_browser(
...
struct _honey_request_context_t* honey_request_context_create_context(
  ...
  return g_libhoney_pointers.honey_request_context_create_context(settings,
                                                              handler);
}
...
struct _honey_request_context_t* honey_create_context_shared(
    ...
    struct _honey_request_context_handler_t* handler) {
  return g_libhoney_pointers.honey_create_context_shared(other, handler);
}

NO_SANITIZE("cfi-icall")
struct _honey_resource_bundle_t* honey_resource_bundle_get_global() {
  return g_libhoney_pointers.honey_resource_bundle_get_global();
}

NO_SANITIZE("cfi-icall") struct _honey_response_t* honey_response_create() {
  return g_libhoney_pointers.honey_response_create();
}
...
void honey_server_create(const honey_string_t* address,
  ...
  g_libhoney_pointers.honey_server_create(address, port, backlog, handler);
}
...
honey_shared_process_message_builder_create(const honey_string_t* name,
                                          size_t byte_size) {
  return g_libhoney_pointers.honey_shared_process_message_builder_create(name,
                                                                     byte_size);
}
...
struct _honey_thread_t* honey_thread_create(
  ...
  return g_libhoney_pointers.honey_thread_create(
...
struct _honey_v8value_t* honey_v8value_create_object(
  ...
  return g_libhoney_pointers.honey_v8value_create_object(accessor, interceptor);
}

NO_SANITIZE("cfi-icall")
struct _honey_v8value_t* honey_v8value_create_array(int length) {
  return g_libhoney_pointers.honey_v8value_create_array(length);
}
...
struct _honey_v8value_t* honey_v8value_create_array_buffer(
  ...
  return g_libhoney_pointers.honey_v8value_create_array_buffer(buffer, length,
                                                           release_callback);
}
...
struct _honey_waitable_event_t* honey_waitable_event_create(
  ...
  return g_libhoney_pointers.honey_waitable_event_create(automatic_reset,
                                                     initially_signaled);
}
...
struct _honey_xml_reader_t* honey_xml_reader_create(
  ...
  return g_libhoney_pointers.honey_xml_reader_create(stream, encodingType, URI);
}

NO_SANITIZE("cfi-icall")
struct _honey_zip_reader_t* honey_zip_reader_create(
    struct _honey_stream_reader_t* stream) {
  return g_libhoney_pointers.honey_zip_reader_create(stream);
}
...
honey_translator_test_ref_ptr_library_child_create(int value, int other_value) {
  return g_libhoney_pointers.honey_translator_test_ref_ptr_library_child_create(
      value, other_value);
}
...
honey_translator_test_scoped_library_create(int value) {
  return g_libhoney_pointers.honey_translator_test_scoped_library_create(value);
}
...
honey_translator_test_scoped_library_child_create(int value, int other_value) {
  return g_libhoney_pointers.honey_translator_test_scoped_library_child_create(
      value, other_value);
}
...
struct _honey_browser_view_t* honey_browser_view_create(
  ...
  return g_libhoney_pointers.honey_browser_view_create(
...
struct _honey_browser_view_t* honey_browser_view_get_for_browser(
  ...
  return g_libhoney_pointers.honey_browser_view_get_for_browser(browser);
}

NO_SANITIZE("cfi-icall") struct _honey_display_t* honey_display_get_primary() {
  return g_libhoney_pointers.honey_display_get_primary();
}

NO_SANITIZE("cfi-icall")
struct _honey_display_t* honey_display_get_nearest_point(const honey_point_t* point,
                                                     int input_pixel_coords) {
  return g_libhoney_pointers.honey_display_get_nearest_point(point,
                                                         input_pixel_coords);
}
...
struct _honey_display_t* honey_display_get_matching_bounds(const honey_rect_t* bounds,
                                                       int input_pixel_coords) {
  return g_libhoney_pointers.honey_display_get_matching_bounds(bounds,
                                                           input_pixel_coords);
}

NO_SANITIZE("cfi-icall") size_t honey_display_get_count() {
  return g_libhoney_pointers.honey_display_get_count();
}

NO_SANITIZE("cfi-icall")
void honey_display_get_alls(size_t* displaysCount,
                          struct _honey_display_t** displays) {
  g_libhoney_pointers.honey_display_get_alls(displaysCount, displays);
}

NO_SANITIZE("cfi-icall")
honey_point_t honey_display_convert_screen_point_to_pixels(
    const honey_point_t* point) {
  return g_libhoney_pointers.honey_display_convert_screen_point_to_pixels(point);
}

NO_SANITIZE("cfi-icall")
honey_point_t honey_display_convert_screen_point_from_pixels(
    const honey_point_t* point) {
  return g_libhoney_pointers.honey_display_convert_screen_point_from_pixels(point);
}

NO_SANITIZE("cfi-icall")
honey_rect_t honey_display_convert_screen_rect_to_pixels(const honey_rect_t* rect) {
  return g_libhoney_pointers.honey_display_convert_screen_rect_to_pixels(rect);
}

NO_SANITIZE("cfi-icall")
honey_rect_t honey_display_convert_screen_rect_from_pixels(const honey_rect_t* rect) {
  return g_libhoney_pointers.honey_display_convert_screen_rect_from_pixels(rect);
}
...
struct _honey_label_button_t* honey_label_button_create(
  ...
  return g_libhoney_pointers.honey_label_button_create(delegate, text);
}
...
int honey_string_map_find(honey_string_map_t map,
                        ...
                        honey_string_t* value) {
  return g_libhoney_pointers.honey_string_map_find(map, key, value);
}

NO_SANITIZE("cfi-icall")
int honey_string_map_key(honey_string_map_t map, size_t index, honey_string_t* key) {
  return g_libhoney_pointers.honey_string_map_key(map, index, key);
}
...
int honey_string_map_value(honey_string_map_t map,
                         size_t index,
                         honey_string_t* value) {
  return g_libhoney_pointers.honey_string_map_value(map, index, value);
}
...
int honey_string_multimap_enumerate(honey_string_multimap_t map,
                                  ...
                                  size_t value_index,
                                  honey_string_t* value) {
  return g_libhoney_pointers.honey_string_multimap_enumerate(map, key, value_index,
                                                         value);
}
...
int honey_string_multimap_key(honey_string_multimap_t map,
                            size_t index,
                            honey_string_t* key) {
  return g_libhoney_pointers.honey_string_multimap_key(map, index, key);
}
...
int honey_string_multimap_value(honey_string_multimap_t map,
                              size_t index,
                              honey_string_t* value) {
  return g_libhoney_pointers.honey_string_multimap_value(map, index, value);
}
...
int honey_string_multimap_append(honey_string_multimap_t map,
                               const honey_string_t* key,
                               const honey_string_t* value) {
  return g_libhoney_pointers.honey_string_multimap_append(map, key, value);
}

NO_SANITIZE("cfi-icall")
void honey_string_multimap_clear(honey_string_multimap_t map) {
  g_libhoney_pointers.honey_string_multimap_clear(map);
}

NO_SANITIZE("cfi-icall")
void honey_string_multimap_free(honey_string_multimap_t map) {
  g_libhoney_pointers.honey_string_multimap_free(map);
}
...
int honey_string_wide_set(const wchar_t* src,
                        ...
                        int copy) {
  return g_libhoney_pointers.honey_string_wide_set(src, src_len, output, copy);
}
...
int honey_string_utf8_set(const char* src,
                        ...
                        int copy) {
  return g_libhoney_pointers.honey_string_utf8_set(src, src_len, output, copy);
}
...
int honey_string_wide_to_utf8(const wchar_t* src,
                            size_t src_len,
                            honey_string_utf8_t* output) {
  return g_libhoney_pointers.honey_string_wide_to_utf8(src, src_len, output);
}
...
int honey_string_utf8_to_wide(const char* src,
                            size_t src_len,
                            honey_string_wide_t* output) {
  return g_libhoney_pointers.honey_string_utf8_to_wide(src, src_len, output);
}
...
int honey_string_wide_to_utf16(const wchar_t* src,
                             size_t src_len,
                             honey_string_utf16_t* output) {
  return g_libhoney_pointers.honey_string_wide_to_utf16(src, src_len, output);
}
...
int honey_string_utf16_to_wide(const char16_t* src,
                             size_t src_len,
                             honey_string_wide_t* output) {
  return g_libhoney_pointers.honey_string_utf16_to_wide(src, src_len, output);
}
...
int honey_string_utf8_to_utf16(const char* src,
                             size_t src_len,
                             honey_string_utf16_t* output) {
  return g_libhoney_pointers.honey_string_utf8_to_utf16(src, src_len, output);
}
...
int honey_string_utf16_to_utf8(const char16_t* src,
                             size_t src_len,
                             honey_string_utf8_t* output) {
  return g_libhoney_pointers.honey_string_utf16_to_utf8(src, src_len, output);
}
...
int honey_string_ascii_to_wide(const char* src,
                             size_t src_len,
                             honey_string_wide_t* output) {
  return g_libhoney_pointers.honey_string_ascii_to_wide(src, src_len, output);
}
...
int honey_string_ascii_to_utf16(const char* src,
                              size_t src_len,
                              honey_string_utf16_t* output) {
  return g_libhoney_pointers.honey_string_ascii_to_utf16(src, src_len, output);
}

NO_SANITIZE("cfi-icall")
honey_string_userfree_wide_t honey_string_userfree_wide_alloc() {
  return g_libhoney_pointers.honey_string_userfree_wide_alloc();
}

NO_SANITIZE("cfi-icall")
honey_string_userfree_utf8_t honey_string_userfree_utf8_alloc() {
  return g_libhoney_pointers.honey_string_userfree_utf8_alloc();
}

NO_SANITIZE("cfi-icall")
honey_string_userfree_utf16_t honey_string_userfree_utf16_alloc() {
  return g_libhoney_pointers.honey_string_userfree_utf16_alloc();
}

NO_SANITIZE("cfi-icall")
void honey_string_userfree_wide_free(honey_string_userfree_wide_t str) {
  g_libhoney_pointers.honey_string_userfree_wide_free(str);
}

NO_SANITIZE("cfi-icall")
void honey_string_userfree_utf8_free(honey_string_userfree_utf8_t str) {
  g_libhoney_pointers.honey_string_userfree_utf8_free(str);
}

NO_SANITIZE("cfi-icall")
void honey_string_userfree_utf16_free(honey_string_userfree_utf16_t str) {
  g_libhoney_pointers.honey_string_userfree_utf16_free(str);
}
...
int honey_string_utf16_to_lower(const char16_t* src,
                              size_t src_len,
                              honey_string_utf16_t* output) {
  return g_libhoney_pointers.honey_string_utf16_to_lower(src, src_len, output);
}
...
int honey_string_utf16_to_upper(const char16_t* src,
                              size_t src_len,
                              honey_string_utf16_t* output) {
  return g_libhoney_pointers.honey_string_utf16_to_upper(src, src_len, output);
}

NO_SANITIZE("cfi-icall")
honey_platform_thread_id_t honey_get_current_platform_thread_id() {
  return g_libhoney_pointers.honey_get_current_platform_thread_id();
}

NO_SANITIZE("cfi-icall")
honey_platform_thread_handle_t honey_get_current_platform_thread_handle() {
  return g_libhoney_pointers.honey_get_current_platform_thread_handle();
}

NO_SANITIZE("cfi-icall")
int honey_time_to_timet(const honey_time_t* honey_time, time_t* time) {
  return g_libhoney_pointers.honey_time_to_timet(honey_time, time);
}

NO_SANITIZE("cfi-icall")
int honey_time_from_timet(time_t time, honey_time_t* honey_time) {
  return g_libhoney_pointers.honey_time_from_timet(time, honey_time);
}

NO_SANITIZE("cfi-icall")
int honey_time_to_doublet(const honey_time_t* honey_time, double* time) {
  return g_libhoney_pointers.honey_time_to_doublet(honey_time, time);
}

NO_SANITIZE("cfi-icall")
int honey_time_from_doublet(double time, honey_time_t* honey_time) {
  return g_libhoney_pointers.honey_time_from_doublet(time, honey_time);
}

NO_SANITIZE("cfi-icall") int honey_time_now(honey_time_t* honey_time) {
  return g_libhoney_pointers.honey_time_now(honey_time);
}

NO_SANITIZE("cfi-icall") honey_basetime_t honey_basetime_now() {
  return g_libhoney_pointers.honey_basetime_now();
}
...
int honey_time_delta(const honey_time_t* honey_time1,
                   ...
                   long long* delta) {
  return g_libhoney_pointers.honey_time_delta(honey_time1, honey_time2, delta);
}

NO_SANITIZE("cfi-icall")
int honey_time_to_basetime(const honey_time_t* from, honey_basetime_t* to) {
  return g_libhoney_pointers.honey_time_to_basetime(from, to);
}

NO_SANITIZE("cfi-icall")
int honey_time_from_basetime(const honey_basetime_t from, honey_time_t* to) {
  return g_libhoney_pointers.honey_time_from_basetime(from, to);
}
...
void honey_trace_event_instant(const char* category,
                             ...
                             uint64_t arg2_val) {
  g_libhoney_pointers.honey_trace_event_instant(category, name, arg1_name, arg1_val,
                                            arg2_name, arg2_val);
}
...
void honey_trace_event_begin(const char* category,
                           ...
                           const char* arg2_name,
                           uint64_t arg2_val) {
  g_libhoney_pointers.honey_trace_event_begin(category, name, arg1_name, arg1_val,
                                          arg2_name, arg2_val);
}
...
void honey_trace_event_end(const char* category,
                         ...
                         const char* arg2_name,
                         uint64_t arg2_val) {
  g_libhoney_pointers.honey_trace_event_end(category, name, arg1_name, arg1_val,
                                        arg2_name, arg2_val);
}
...
void honey_trace_counter(const char* category,
                       ...
                       uint64_t value2_val) {
  g_libhoney_pointers.honey_trace_counter(category, name, value1_name, value1_val,
...
void honey_trace_counter_id(const char* category,
                          ...
                          const char* value2_name,
                          uint64_t value2_val) {
  g_libhoney_pointers.honey_trace_counter_id(category, name, id, value1_name,
...
void honey_trace_event_async_begin(const char* category,
                                 ...
                                 const char* arg2_name,
                                 uint64_t arg2_val) {
  g_libhoney_pointers.honey_trace_event_async_begin(category, name, id, arg1_name,
...
void honey_trace_event_async_step_into(const char* category,
                                     ...
                                     const char* arg1_name,
                                     uint64_t arg1_val) {
  g_libhoney_pointers.honey_trace_event_async_step_into(category, name, id, step,
                                                    arg1_name, arg1_val);
}
...
void honey_trace_event_async_step_past(const char* category,
                                     ...
                                     const char* arg1_name,
                                     uint64_t arg1_val) {
  g_libhoney_pointers.honey_trace_event_async_step_past(category, name, id, step,
                                                    arg1_name, arg1_val);
}
...
void honey_trace_event_async_end(const char* category,
                               ...
                               const char* arg2_name,
                               uint64_t arg2_val) {
  g_libhoney_pointers.honey_trace_event_async_end(category, name, id, arg1_name,
                                              arg1_val, arg2_name, arg2_val);
}
