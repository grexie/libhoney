...
HoneycombSize HoneycombPanelDelegateCToCpp::GetPreferredSize(HoneycombRefPtr<HoneycombView> view) {
...
NO_SANITIZE("cfi-icall")
HoneycombSize HoneycombPanelDelegateCToCpp::GetMinimumSize(HoneycombRefPtr<HoneycombView> view) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall")
HoneycombSize HoneycombPanelDelegateCToCpp::GetMaximumSize(HoneycombRefPtr<HoneycombView> view) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall")
int HoneycombPanelDelegateCToCpp::GetHeightForWidth(HoneycombRefPtr<HoneycombView> view,
                                              int width) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall")
void HoneycombPanelDelegateCToCpp::OnParentViewChanged(HoneycombRefPtr<HoneycombView> view,
                                                 bool added,
...
NO_SANITIZE("cfi-icall")
void HoneycombPanelDelegateCToCpp::OnChildViewChanged(HoneycombRefPtr<HoneycombView> view,
                                                bool added,
...
NO_SANITIZE("cfi-icall")
void HoneycombPanelDelegateCToCpp::OnWindowChanged(HoneycombRefPtr<HoneycombView> view,
                                             bool added) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall")
void HoneycombPanelDelegateCToCpp::OnLayoutChanged(HoneycombRefPtr<HoneycombView> view,
...
NO_SANITIZE("cfi-icall")
void HoneycombPanelDelegateCToCpp::OnFocus(HoneycombRefPtr<HoneycombView> view) {
  shutdown_checker::AssertNotShutdown();
...
NO_SANITIZE("cfi-icall")
void HoneycombPanelDelegateCToCpp::OnBlur(HoneycombRefPtr<HoneycombView> view) {
  shutdown_checker::AssertNotShutdown();
...
HoneycombPanelDelegateCToCpp::HoneycombPanelDelegateCToCpp() {}
...
HoneycombCToCppRefCounted<HoneycombPanelDelegateCToCpp,
                    HoneycombPanelDelegate,
                    honey_panel_delegate_t>::UnwrapDerived(HoneycombWrapperType type,
                                                         HoneycombPanelDelegate* c) {
  if (type == WT_WINDOW_DELEGATE) {
    return reinterpret_cast<honey_panel_delegate_t*>(
...
template <>
HoneycombWrapperType HoneycombCToCppRefCounted<HoneycombPanelDelegateCToCpp,
                                   HoneycombPanelDelegate,
