...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_MENU_RUNNER_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_MENU_RUNNER_H_
...
#endif  // HONEYCOMB_LIBHONEYCOMB_BROWSER_MENU_RUNNER_H_
