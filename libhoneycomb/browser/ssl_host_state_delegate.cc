// Copyright (c) 2014 The Chromium Authors and 2016 the CEF Authors. All rights reserved.
...
HoneycombSSLHostStateDelegate::HoneycombSSLHostStateDelegate() {}

HoneycombSSLHostStateDelegate::~HoneycombSSLHostStateDelegate() {}

void HoneycombSSLHostStateDelegate::HostRanInsecureContent(
...
bool HoneycombSSLHostStateDelegate::DidHostRunInsecureContent(
    const std::string& host,
    int child_id,
    InsecureContentType content_type) {
  // Intentional no-op.
...
void HoneycombSSLHostStateDelegate::AllowHttpForHost(
    const std::string& host,
    content::StoragePartition* storage_partition) {
  // Intentional no-op.
}

bool HoneycombSSLHostStateDelegate::IsHttpAllowedForHost(
    const std::string& host,
    content::StoragePartition* storage_partition) {
...
void HoneycombSSLHostStateDelegate::SetHttpsEnforcementForHost(
    const std::string& host,
    bool enforce,
    content::StoragePartition* storage_partition) {
  // Intentional no-op.
...
bool HoneycombSSLHostStateDelegate::IsHttpsEnforcedForHost(
    const std::string& host,
    content::StoragePartition* storage_partition) {
...
void HoneycombSSLHostStateDelegate::AllowCert(
    const std::string& host,
...
void HoneycombSSLHostStateDelegate::Clear(
...
SSLHostStateDelegate::CertJudgment HoneycombSSLHostStateDelegate::QueryPolicy(
    const std::string& host,
    const net::X509Certificate& cert,
    int error,
    content::StoragePartition* storage_partition) {
...
void HoneycombSSLHostStateDelegate::RevokeUserAllowExceptions(
    const std::string& host) {
  cert_policy_for_host_.erase(host);
}

bool HoneycombSSLHostStateDelegate::HasAllowException(
    const std::string& host,
    content::StoragePartition* storage_partition) {
...
bool HoneycombSSLHostStateDelegate::HasAllowExceptionForAnyHost(
    content::StoragePartition* storage_partition) {
