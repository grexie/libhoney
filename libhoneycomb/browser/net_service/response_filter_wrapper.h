...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_NET_SERVICE_RESPONSE_FILTER_WRAPPER_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_NET_SERVICE_RESPONSE_FILTER_WRAPPER_H_
...
#endif  // HONEYCOMB_LIBHONEYCOMB_BROWSER_NET_SERVICE_RESPONSE_FILTER_WRAPPER_H_
