...
class SkipCallbackWrapper : public HoneycombResourceSkipCallback {
 public:
...
class ReadCallbackWrapper : public HoneycombResourceReadCallback {
 public:
...
// Helper for accessing a HoneycombResourceHandler without creating reference loops.
class HandlerProvider : public base::RefCountedThreadSafe<HandlerProvider> {
 public:
  explicit HandlerProvider(HoneycombRefPtr<HoneycombResourceHandler> handler)
      : handler_(handler) {
    DCHECK(handler_);
  }
  ...
  HoneycombRefPtr<HoneycombResourceHandler> handler() const {
  ...
  void Detach() {
    ...
    HONEYCOMB_POST_TASK(HONEYCOMB_IOT,
                  base::BindOnce(&HoneycombResourceHandler::Cancel, handler_));
 ...
 private:
  ...
  HoneycombRefPtr<HoneycombResourceHandler> handler_;
};

class ReadResponseCallbackWrapper : public HoneycombCallback {
 public:
  ...
  static void ReadResponse(scoped_refptr<HandlerProvider> handler_provider,
                           net::IOBuffer* dest,
                           int length,
                           HoneycombRefPtr<ReadCallbackWrapper> callback) {
    HONEYCOMB_POST_TASK(
        HONEYCOMB_IOT,
 ...
 private:
  ...
  static void ReadResponseOnIOThread(
    ...
    HoneycombRefPtr<ReadResponseCallbackWrapper> callbackWrapper =
  ...
  int length_;
  HoneycombRefPtr<ReadCallbackWrapper> callback_;
...
class InputStreamWrapper : public InputStream {
 public:
  ...
  bool Skip(int64_t n, int64_t* bytes_skipped, SkipCallback callback) override {
    ...
    HoneycombRefPtr<SkipCallbackWrapper> callbackWrapper =
  ...
  bool Read(net::IOBuffer* dest,
    ...
    HoneycombRefPtr<ReadCallbackWrapper> callbackWrapper =
...
class OpenCallbackWrapper : public HoneycombCallback {
 public:
...
void CallProcessRequestOnIOThread(
    ...
    HoneycombRefPtr<OpenCallbackWrapper> callbackWrapper) {
  HONEYCOMB_REQUIRE_IOT();
...
class ResourceResponseWrapper : public ResourceResponse {
 public:
  ...
  bool OpenInputStream(int32_t request_id,
    ...
    request_ = new HoneycombRequestImpl();
    request_->Set(&request, request_id);
    request_->SetReadOnly(true);

    HoneycombRefPtr<OpenCallbackWrapper> callbackWrapper = new OpenCallbackWrapper(
        std::move(callback),
    ...
    HONEYCOMB_POST_TASK(
        HONEYCOMB_IOT, base::BindOnce(CallProcessRequestOnIOThread, handler_provider_,
 ...
 private:
  ...
  HoneycombRefPtr<HoneycombRequestImpl> request_;
  scoped_refptr<HandlerProvider> handler_provider_;
};
