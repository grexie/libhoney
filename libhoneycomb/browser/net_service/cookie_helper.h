...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_NET_SERVICE_COOKIE_HELPER_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_NET_SERVICE_COOKIE_HELPER_H_
...
void LoadCookies(const HoneycombBrowserContext::Getter& browser_context_getter,
...
// on the IO thread.
void SaveCookies(const HoneycombBrowserContext::Getter& browser_context_getter,
                 const network::ResourceRequest& request,
...
#endif  // HONEYCOMB_LIBHONEYCOMB_BROWSER_NET_SERVICE_COOKIE_HELPER_H_
