...
#include "libhoneycomb/browser/origin_whitelist_impl.h"
...
class ResourceContextData : public base::SupportsUserData::Data {
 public:
  ...
  static void AddProxyOnUIThread(
    ...
    HONEYCOMB_POST_TASK(HONEYCOMB_IOT, base::BindOnce(ResourceContextData::AddProxy,
