...
class ResponseFilterWrapper {
 public:
  ResponseFilterWrapper(HoneycombRefPtr<HoneycombResponseFilter> filter,
 ...
 private:
  ...
  HoneycombRefPtr<HoneycombResponseFilter> filter_;
  ...
  honey_response_filter_status_t last_status_ = RESPONSE_FILTER_NEED_MORE_DATA;
};

ResponseFilterWrapper::ResponseFilterWrapper(
    HoneycombRefPtr<HoneycombResponseFilter> filter,
    mojo::ScopedDataPipeConsumerHandle source_handle,
    base::OnceClosure error_callback)
    : filter_(filter),
