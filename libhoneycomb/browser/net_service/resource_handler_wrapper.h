...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_NET_SERVICE_RESOURCE_HANDLER_WRAPPER_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_NET_SERVICE_RESOURCE_HANDLER_WRAPPER_H_
...
#endif  // HONEYCOMB_LIBHONEYCOMB_BROWSER_NET_SERVICE_RESOURCE_HANDLER_WRAPPER_H_
