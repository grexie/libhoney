...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_OSR_RENDER_WIDGET_HOST_VIEW_OSR_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_OSR_RENDER_WIDGET_HOST_VIEW_OSR_H_
#pragma once
...
#include "libhoneycomb/browser/osr/host_display_client_osr.h"
#include "libhoneycomb/browser/osr/motion_event_osr.h"
...
class HoneycombCopyFrameGenerator;
class HoneycombSoftwareOutputDeviceOSR;
class HoneycombTouchSelectionControllerClientOSR;
class HoneycombVideoConsumerOSR;
class HoneycombWebContentsViewOSR;

///////////////////////////////////////////////////////////////////////////////
// HoneycombRenderWidgetHostViewOSR
//
//  An object representing the "View" of a rendered web page. This object is
//  responsible for sending paint events to the the HoneycombRenderHandler
...
class HoneycombRenderWidgetHostViewOSR
 ...
 public:
  HoneycombRenderWidgetHostViewOSR(SkColor background_color,
                             bool use_shared_texture,
                             bool use_external_begin_frame,
                             content::RenderWidgetHost* widget,
                             HoneycombRenderWidgetHostViewOSR* parent_host_view);

  HoneycombRenderWidgetHostViewOSR(const HoneycombRenderWidgetHostViewOSR&) = delete;
  HoneycombRenderWidgetHostViewOSR& operator=(const HoneycombRenderWidgetHostViewOSR&) =
      delete;

  ~HoneycombRenderWidgetHostViewOSR() override;
  ...
  void Invalidate(HoneycombBrowserHost::PaintElementType type);
  void SendExternalBeginFrame();
  void SendKeyEvent(const content::NativeWebKeyboardEvent& event);
  void SendMouseEvent(const blink::WebMouseEvent& event);
  void SendMouseWheelEvent(const blink::WebMouseWheelEvent& event);
  void SendTouchEvent(const HoneycombTouchEvent& event);
  ...
  HoneycombRefPtr<AlloyBrowserHostImpl> browser_impl() const { return browser_impl_; }
  void set_browser_impl(HoneycombRefPtr<AlloyBrowserHostImpl> browser) {
    browser_impl_ = browser;
  }

  void set_popup_host_view(HoneycombRenderWidgetHostViewOSR* popup_view) {
    if (popup_view != popup_host_view_) {
      forward_touch_to_popup_ = false;
    }
    popup_host_view_ = popup_view;
  }
  void set_child_host_view(HoneycombRenderWidgetHostViewOSR* popup_view) {
  ...
  HoneycombTouchSelectionControllerClientOSR* selection_controller_client() const {
 ...
 private:
  ...
  void AddGuestHostView(HoneycombRenderWidgetHostViewOSR* guest_host);
  void RemoveGuestHostView(HoneycombRenderWidgetHostViewOSR* guest_host);
  ...
  std::unique_ptr<HoneycombTouchSelectionControllerClientOSR>
  ...
  HoneycombHostDisplayClientOSR* host_display_client_ = nullptr;
  std::unique_ptr<HoneycombVideoConsumerOSR> video_consumer_;
  ...
  bool has_parent_;
  HoneycombRenderWidgetHostViewOSR* parent_host_view_;
  HoneycombRenderWidgetHostViewOSR* popup_host_view_ = nullptr;
  HoneycombRenderWidgetHostViewOSR* child_host_view_ = nullptr;
  std::set<HoneycombRenderWidgetHostViewOSR*> guest_host_views_;

  HoneycombRefPtr<AlloyBrowserHostImpl> browser_impl_;
  ...
  HoneycombMotionEventOSR pointer_state_;
  bool forward_touch_to_popup_ = false;

  base::WeakPtrFactory<HoneycombRenderWidgetHostViewOSR> weak_ptr_factory_;
};

#endif  // HONEYCOMB_LIBHONEYCOMB_BROWSER_OSR_RENDER_WIDGET_HOST_VIEW_OSR_H_
