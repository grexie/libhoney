...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_OSR_TOUCH_SELECTION_CONTROLLER_CLIENT_OSR_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_OSR_TOUCH_SELECTION_CONTROLLER_CLIENT_OSR_H_
...
class HoneycombTouchSelectionControllerClientOSR
 ...
 public:
  explicit HoneycombTouchSelectionControllerClientOSR(
      HoneycombRenderWidgetHostViewOSR* rwhv);

  HoneycombTouchSelectionControllerClientOSR(
      const HoneycombTouchSelectionControllerClientOSR&) = delete;
  HoneycombTouchSelectionControllerClientOSR& operator=(
      const HoneycombTouchSelectionControllerClientOSR&) = delete;

  ~HoneycombTouchSelectionControllerClientOSR() override;
 ...
 private:
  ...
  class InternalClient final : public ui::TouchSelectionControllerClient {
   public:
    explicit InternalClient(HoneycombRenderWidgetHostViewOSR* rwhv) : rwhv_(rwhv) {}
  ...
  base::WeakPtrFactory<HoneycombTouchSelectionControllerClientOSR> weak_ptr_factory_;
};
