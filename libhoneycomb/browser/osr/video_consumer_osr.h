#ifndef libhoneycombCOMB_BROWSER_OSR_VIDEO_CONSUMER_OSR_H_
#define libhoneycombCOMB_BROWSER_OSR_VIDEO_CONSUMER_OSR_H_
...
#endif  // libhoneycombCOMB_BROWSER_OSR_VIDEO_CONSUMER_OSR_H_