...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_CHROME_BROWSER_DELEGATE_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_CHROME_BROWSER_DELEGATE_H_
#pragma once
...
class BrowserDelegate : public content::WebContentsDelegate {
 public:
  // Opaque ref-counted base class for Honeycomb-specific parameters passed via
  // Browser::CreateParams::honey_params and possibly shared by multiple Browser
  // instances.
  ...
  // opportunity for Honeycomb to create a new Browser instead of proceeding with
...
#endif  // HONEYCOMB_LIBHONEYCOMB_BROWSER_CHROME_BROWSER_DELEGATE_H_
