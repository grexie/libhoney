...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_CHROME_VIEWS_CHROME_BROWSER_FRAME_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_CHROME_VIEWS_CHROME_BROWSER_FRAME_H_
#pragma once
...
// then creates the necessary Browser view, window and frame objects. Honeycomb has
// modified the default object creation model are described below to better
// integrate with the existing Honeycomb Views APIs.
//
// OVERVIEW
//
...
// - Extended by Honeycomb as ChromeBrowserView.
// BrowserFrame:
...
// - Extended by Honeycomb as ChromeBrowserFrame.
//
...
//
// Honeycomb MODIFICATIONS
//
// The Honeycomb Views integration uses an alternative approach of creating the
// ChromeBrowserFrame in HoneycombWindowView::CreateWidget() and the
// ChromeBrowserView in HoneycombBrowserViewImpl::CreateRootView().
...
//
// Honeycomb does not use Chrome's NativeBrowserFrame (aka DesktopBrowserFrameAura),
...
//
// Honeycomb does not pass ChromeBrowserView as the WidgetDelegate when the Widget is
// initialized in HoneycombWindowView::CreateWidget(). Some of the WidgetDelegate
// callbacks may need to be routed from HoneycombWindowView to ChromeBrowserView in
// the future.
//
...
// HoneycombWindowView::CreateWidget() when the Chrome runtime is enabled.
...
#endif  // HONEYCOMB_LIBHONEYCOMB_BROWSER_CHROME_VIEWS_CHROME_BROWSER_FRAME_H_
