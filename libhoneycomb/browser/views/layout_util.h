...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_VIEWS_LAYOUT_UTIL_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_VIEWS_LAYOUT_UTIL_H_
#pragma once
...
#endif  // HONEYCOMB_LIBHONEYCOMB_BROWSER_VIEWS_LAYOUT_UTIL_H_
