...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_VIEWS_BASIC_PANEL_VIEW_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_VIEWS_BASIC_PANEL_VIEW_H_
#pragma once
...
#endif  // HONEYCOMB_LIBHONEYCOMB_BROWSER_VIEWS_BASIC_PANEL_VIEW_H_
