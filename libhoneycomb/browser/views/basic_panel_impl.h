...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_VIEWS_BASIC_PANEL_IMPL_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_VIEWS_BASIC_PANEL_IMPL_H_
#pragma once

#include "include/views/honey_panel.h"
#include "include/views/honey_panel_delegate.h"

#include "libhoneycomb/browser/views/panel_impl.h"
...
#endif  // HONEYCOMB_LIBHONEYCOMB_BROWSER_VIEWS_BASIC_PANEL_IMPL_H_
