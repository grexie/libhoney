...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_EXTENSIONS_EXTENSION_SYSTEM_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_EXTENSIONS_EXTENSION_SYSTEM_H_
...
class HoneycombExtensionSystem : public ExtensionSystem {
 public:
  explicit HoneycombExtensionSystem(content::BrowserContext* browser_context);

  HoneycombExtensionSystem(const HoneycombExtensionSystem&) = delete;
  HoneycombExtensionSystem& operator=(const HoneycombExtensionSystem&) = delete;

  ~HoneycombExtensionSystem() override;
  ...
  HoneycombRefPtr<HoneycombExtension> GetExtension(const std::string& extension_id) const;

  using ExtensionMap = std::map<std::string, HoneycombRefPtr<HoneycombExtension>>;
  ...
  void OnRequestContextDeleted(HoneycombRequestContext* context);
 ...
 private:
  ...
  // Map of extension ID to Honeycomb extension object.
  ExtensionMap extension_map_;

  // Must be the last member.
  base::WeakPtrFactory<HoneycombExtensionSystem> weak_ptr_factory_;
};

}  // namespace extensions

#endif  // HONEYCOMB_LIBHONEYCOMB_BROWSER_EXTENSIONS_EXTENSION_SYSTEM_H_
