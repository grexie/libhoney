...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_EXTENSIONS_VALUE_STORE_HONEYCOMB_VALUE_STORE_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_EXTENSIONS_VALUE_STORE_HONEYCOMB_VALUE_STORE_H_
...
// operations.
class HoneycombValueStore : public ValueStore {
 public:
  HoneycombValueStore();
  ~HoneycombValueStore() override;
  HoneycombValueStore(const HoneycombValueStore&) = delete;
  HoneycombValueStore& operator=(const HoneycombValueStore&) = delete;
...
#endif  // HONEYCOMB_LIBHONEYCOMB_BROWSER_EXTENSIONS_VALUE_STORE_HONEYCOMB_VALUE_STORE_H_
