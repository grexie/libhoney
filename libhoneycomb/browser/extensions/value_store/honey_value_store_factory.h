...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_EXTENSIONS_VALUE_STORE_HONEYCOMB_VALUE_STORE_FACTORY_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_EXTENSIONS_VALUE_STORE_HONEYCOMB_VALUE_STORE_FACTORY_H_
...
// provided) returning a |LeveldbValueStore|. Otherwise a new |HoneycombingValueStore|
// instance will be returned.
class HoneycombValueStoreFactory : public ValueStoreFactory {
 public:
  HoneycombValueStoreFactory();
  explicit HoneycombValueStoreFactory(const base::FilePath& db_path);
  HoneycombValueStoreFactory(const HoneycombValueStoreFactory&) = delete;
  HoneycombValueStoreFactory& operator=(const HoneycombValueStoreFactory&) = delete;
 ...
 private:
  ~HoneycombValueStoreFactory() override;
...
#endif  // HONEYCOMB_LIBHONEYCOMB_BROWSER_EXTENSIONS_VALUE_STORE_HONEYCOMB_VALUE_STORE_FACTORY_H_
