...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_EXTENSIONS_EXTENSIONS_BROWSER_CLIENT_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_EXTENSIONS_EXTENSIONS_BROWSER_CLIENT_H_
...
class HoneycombExtensionsBrowserClient : public ExtensionsBrowserClient {
 public:
  HoneycombExtensionsBrowserClient();

  HoneycombExtensionsBrowserClient(const HoneycombExtensionsBrowserClient&) = delete;
  HoneycombExtensionsBrowserClient& operator=(const HoneycombExtensionsBrowserClient&) =
      delete;

  ~HoneycombExtensionsBrowserClient() override;

  // Returns the singleton HoneycombExtensionsBrowserClient instance.
  static HoneycombExtensionsBrowserClient* Get();
...
#endif  // HONEYCOMB_LIBHONEYCOMB_BROWSER_EXTENSIONS_EXTENSIONS_BROWSER_CLIENT_H_
