...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_EXTENSIONS_CHROME_API_REGISTRATION_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_EXTENSIONS_CHROME_API_REGISTRATION_H_
...
#endif  // HONEYCOMB_LIBHONEYCOMB_BROWSER_EXTENSIONS_CHROME_API_REGISTRATION_H_
