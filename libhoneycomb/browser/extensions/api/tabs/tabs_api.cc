...
TabsCreateFunction::TabsCreateFunction() : honey_details_(this) {}
...
ExtensionFunction::ResponseAction TabsCreateFunction::Run() {
  ...
  HoneycombExtensionFunctionDetails::OpenTabParams options;
  ...
  std::string error;
  auto result = honey_details_.OpenTab(options, user_gesture(), &error);
  if (!result) {
...
BaseAPIFunction::BaseAPIFunction() : honey_details_(this) {}
...
content::WebContents* BaseAPIFunction::GetWebContents(int tab_id) {
  ...
  HoneycombRefPtr<AlloyBrowserHostImpl> browser =
      honey_details_.GetBrowserForTabIdFirstTime(tab_id, &error_);
  if (!browser) {
    return nullptr;
  }
...
ExtensionFunction::ResponseValue TabsUpdateFunction::GetResult() {
  ...
  return ArgumentList(tabs::Get::Results::Create(honey_details_.CreateTabObject(
      AlloyBrowserHostImpl::GetBrowserForContents(web_contents_),
      /*opener_browser_id=*/-1, /*active=*/true, tab_id_)));
}

ExecuteCodeInTabFunction::ExecuteCodeInTabFunction()
    : honey_details_(this), execute_tab_id_(-1) {}
...
ExecuteCodeFunction::InitResult ExecuteCodeInTabFunction::Init() {
  ...
  std::string error;
  HoneycombRefPtr<AlloyBrowserHostImpl> browser =
      honey_details_.GetBrowserForTabIdFirstTime(tab_id, &error);
  if (!browser) {
...
bool ExecuteCodeInTabFunction::CanExecuteScriptOnPage(std::string* error) {
  ...
  HoneycombRefPtr<AlloyBrowserHostImpl> browser =
      honey_details_.GetBrowserForTabIdAgain(execute_tab_id_, error);
  if (!browser) {
    return false;
  }
...
ScriptExecutor* ExecuteCodeInTabFunction::GetScriptExecutor(
  ...
  return HoneycombExtensionWebContentsObserver::FromWebContents(
