// Copyright 2017 The Chromium Authors and 2016 the CEF Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#include "libhoneycomb/browser/extensions/api/file_system/honey_file_system_delegate.h"
...
HoneycombFileSystemDelegate::HoneycombFileSystemDelegate() = default;

HoneycombFileSystemDelegate::~HoneycombFileSystemDelegate() = default;

base::FilePath HoneycombFileSystemDelegate::GetDefaultDirectory() {
  return base::FilePath();
}

base::FilePath HoneycombFileSystemDelegate::GetManagedSaveAsDirectory(
    content::BrowserContext* browser_context,
    const Extension& extension) {
  return base::FilePath();
}

bool HoneycombFileSystemDelegate::ShowSelectFileDialog(
...
void HoneycombFileSystemDelegate::ConfirmSensitiveDirectoryAccess(
...
int HoneycombFileSystemDelegate::GetDescriptionIdForAcceptType(
...
SavedFilesServiceInterface* HoneycombFileSystemDelegate::GetSavedFilesService(
    content::BrowserContext* browser_context) {
