...
#include "libhoneycomb/browser/extensions/component_extension_resource_manager.h"
...
HoneycombComponentExtensionResourceManager::HoneycombComponentExtensionResourceManager() {
...
bool HoneycombComponentExtensionResourceManager::IsComponentExtensionResource(
...
HoneycombComponentExtensionResourceManager::GetTemplateReplacementsForExtension(
    const std::string& extension_id) const {
  auto it = template_replacements_.find(extension_id);
  return it != template_replacements_.end() ? &it->second : nullptr;
}

void HoneycombComponentExtensionResourceManager::AddComponentResourceEntries(
