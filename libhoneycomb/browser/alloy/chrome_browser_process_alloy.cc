...
// Portions (c) 2011 The Chromium Authors and 2016 the CEF Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#include "libhoneycomb/browser/alloy/chrome_browser_process_alloy.h"
...
void ChromeBrowserProcessAlloy::Initialize() {
  ...
  if (extensions::ExtensionsEnabled()) {
    ...
    extensions_browser_client_.reset(
        new extensions::HoneycombExtensionsBrowserClient);
...
void ChromeBrowserProcessAlloy::CleanupOnUIThread() {
  ...
  for (const auto& browser_context : HoneycombBrowserContext::GetAll()) {
