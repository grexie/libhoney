...
#include "libhoneycomb/browser/alloy/chrome_profile_alloy.h"
...
class HoneycombVariationsClient : public variations::VariationsClient {
 public:
  explicit HoneycombVariationsClient(content::BrowserContext* browser_context)
      : browser_context_(browser_context) {}

  ~HoneycombVariationsClient() override = default;
...
variations::VariationsClient* ChromeProfileAlloy::GetVariationsClient() {
  if (!variations_client_) {
    variations_client_ = std::make_unique<HoneycombVariationsClient>(this);
  }
