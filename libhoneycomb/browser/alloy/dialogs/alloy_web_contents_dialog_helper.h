...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_ALLOY_DIALOGS_ALLOY_WEB_CONTENTS_DIALOG_HELPER_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_ALLOY_DIALOGS_ALLOY_WEB_CONTENTS_DIALOG_HELPER_H_
#pragma once
...
class AlloyWebContentsDialogHelper
 ...
 public:
  AlloyWebContentsDialogHelper(content::WebContents* web_contents,
                               HoneycombBrowserPlatformDelegate* browser_delegate);
 ...
 private:
  ...
  HoneycombBrowserPlatformDelegate* const browser_delegate_;
...
#endif  // HONEYCOMB_LIBHONEYCOMB_BROWSER_ALLOY_DIALOGS_ALLOY_WEB_CONTENTS_DIALOG_HELPER_H_
