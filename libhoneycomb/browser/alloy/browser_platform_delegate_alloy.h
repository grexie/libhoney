...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_ALLOY_BROWSER_PLATFORM_DELEGATE_ALLOY_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_ALLOY_BROWSER_PLATFORM_DELEGATE_ALLOY_H_

#include "libhoneycomb/browser/alloy/dialogs/alloy_web_contents_dialog_helper.h"
...
class HoneycombBrowserPlatformDelegateAlloy : public HoneycombBrowserPlatformDelegate {
 public:
  HoneycombBrowserPlatformDelegateAlloy(const HoneycombBrowserPlatformDelegateAlloy&) =
      delete;
  HoneycombBrowserPlatformDelegateAlloy& operator=(
      const HoneycombBrowserPlatformDelegateAlloy&) = delete;

  content::WebContents* CreateWebContents(HoneycombBrowserCreateParams& create_params,
 ...
 protected:
  HoneycombBrowserPlatformDelegateAlloy();
 ...
 private:
  ...
  base::WeakPtrFactory<HoneycombBrowserPlatformDelegateAlloy> weak_ptr_factory_;
};

#endif  // HONEYCOMB_LIBHONEYCOMB_BROWSER_ALLOY_BROWSER_PLATFORM_DELEGATE_ALLOY_H_
