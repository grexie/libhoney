...
@interface HoneycombJavaScriptDialogHelper : NSObject <NSAlertDelegate> {
 @private
  NSAlert* __strong alert_;
  NSTextField* __weak textField_;

  // Copies of the fields in HoneycombJavaScriptDialog because they're private.
  HoneycombJavaScriptDialogRunner::DialogClosedCallback callback_;
}

- (id)initHelperWithCallback:
    (HoneycombJavaScriptDialogRunner::DialogClosedCallback)callback;
- (NSAlert*)alert;
...
@implementation HoneycombJavaScriptDialogHelper
...
HoneycombJavaScriptDialogRunnerMac::HoneycombJavaScriptDialogRunnerMac()
...
void HoneycombJavaScriptDialogRunnerMac::Run(
  ...
  helper_ = [[HoneycombJavaScriptDialogHelper alloc]
      initHelperWithCallback:base::BindOnce(
                                 &HoneycombJavaScriptDialogRunnerMac::DialogClosed,
...
void HoneycombJavaScriptDialogRunnerMac::Handle(
    bool accept,
...
void HoneycombJavaScriptDialogRunnerMac::Cancel() {
  if (helper_) {
    [helper_ cancel];
    helper_ = nil;
  }
...
void HoneycombJavaScriptDialogRunnerMac::DialogClosed(
    bool success,
