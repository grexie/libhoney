...
#include "libhoneycomb/browser/audio_loopback_stream_creator.h"
...
// HoneycombAudioLoopbackStreamCreator::StreamCreatedCallback. The callback runs when
...
class StreamCreatedCallbackAdapter final
 ...
 public:
  explicit StreamCreatedCallbackAdapter(
      const HoneycombAudioLoopbackStreamCreator::StreamCreatedCallback& callback)
      : callback_(callback) {
    DCHECK(callback_);
  }
 ...
 private:
  const HoneycombAudioLoopbackStreamCreator::StreamCreatedCallback callback_;
};
...
HoneycombAudioLoopbackStreamCreator::HoneycombAudioLoopbackStreamCreator()
    : factory_(nullptr,
...
void HoneycombAudioLoopbackStreamCreator::CreateLoopbackStream(
