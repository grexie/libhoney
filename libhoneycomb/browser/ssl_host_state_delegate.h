...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_SSL_HOST_STATE_DELEGATE_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_SSL_HOST_STATE_DELEGATE_H_
...
class HoneycombSSLHostStateDelegate : public content::SSLHostStateDelegate {
 public:
  HoneycombSSLHostStateDelegate();

  HoneycombSSLHostStateDelegate(const HoneycombSSLHostStateDelegate&) = delete;
  HoneycombSSLHostStateDelegate& operator=(const HoneycombSSLHostStateDelegate&) = delete;

  ~HoneycombSSLHostStateDelegate() override;
...
#endif  // HONEYCOMB_LIBHONEYCOMB_BROWSER_SSL_HOST_STATE_DELEGATE_H_
