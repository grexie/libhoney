...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_PREFS_PREF_STORE_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_PREFS_PREF_STORE_H_
...
class HoneycombPrefStore : public PersistentPrefStore {
 public:
  HoneycombPrefStore();

  HoneycombPrefStore(const HoneycombPrefStore&) = delete;
  HoneycombPrefStore& operator=(const HoneycombPrefStore&) = delete;
