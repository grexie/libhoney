...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_PREFS_BROWSER_PREFS_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_PREFS_BROWSER_PREFS_H_
...
// Register preferences specific to Honeycomb.
...
#endif  // HONEYCOMB_LIBHONEYCOMB_BROWSER_PREFS_BROWSER_PREFS_H_
