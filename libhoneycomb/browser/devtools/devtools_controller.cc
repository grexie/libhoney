...
#include "libhoneycomb/browser/devtools/devtools_controller.h"

#include "libhoneycomb/browser/devtools/devtools_util.h"
...
HoneycombDevToolsController::HoneycombDevToolsController(
...
bool HoneycombDevToolsController::SendDevToolsMessage(
...
int HoneycombDevToolsController::ExecuteDevToolsMethod(
...
void HoneycombDevToolsController::AgentHostClosed(
...
void HoneycombDevToolsController::AddObserver(Observer* observer) {
  HONEYCOMB_REQUIRE_UIT();
  observers_.AddObserver(observer);
}

void HoneycombDevToolsController::RemoveObserver(Observer* observer) {
  HONEYCOMB_REQUIRE_UIT();
  observers_.RemoveObserver(observer);
}

void HoneycombDevToolsController::DispatchProtocolMessage(
    content::DevToolsAgentHost* agent_host,
...
bool HoneycombDevToolsController::EnsureAgentHost() {
  if (!agent_host_) {
    agent_host_ =
