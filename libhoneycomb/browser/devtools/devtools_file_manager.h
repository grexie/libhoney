...
#ifndef HONEYCOMB_LIBHONEYCOMB_BROWSER_DEVTOOLS_DEVTOOLS_FILE_MANAGER_H_
#define HONEYCOMB_LIBHONEYCOMB_BROWSER_DEVTOOLS_DEVTOOLS_FILE_MANAGER_H_
...
class HoneycombDevToolsFileManager {
 public:
  HoneycombDevToolsFileManager(AlloyBrowserHostImpl* browser_impl,
                         PrefService* prefs);

  HoneycombDevToolsFileManager(const HoneycombDevToolsFileManager&) = delete;
  HoneycombDevToolsFileManager& operator=(const HoneycombDevToolsFileManager&) = delete;
 ...
 private:
  ...
  base::WeakPtrFactory<HoneycombDevToolsFileManager> weak_factory_;
};

#endif  // HONEYCOMB_LIBHONEYCOMB_BROWSER_DEVTOOLS_DEVTOOLS_FILE_MANAGER_H_
