...
std::unique_ptr<content::DevToolsSocketFactory> CreateSocketFactory() {
  ...
  // for Honeycomb where the URL is otherwise undiscoverable. Also, don't allow
...
// static
void HoneycombDevToolsManagerDelegate::StartHttpHandler(
...
// static
void HoneycombDevToolsManagerDelegate::StopHttpHandler() {
  // This is a no-op if the server was never started.
  content::DevToolsAgentHost::StopRemoteDebuggingServer();
}

HoneycombDevToolsManagerDelegate::HoneycombDevToolsManagerDelegate() {}

HoneycombDevToolsManagerDelegate::~HoneycombDevToolsManagerDelegate() {}

scoped_refptr<content::DevToolsAgentHost>
HoneycombDevToolsManagerDelegate::CreateNewTarget(
    const GURL& url,
  ...
  // DevTools interface.
  // TODO(honey): Consider exposing new API to support this.
  return nullptr;
}

std::string HoneycombDevToolsManagerDelegate::GetDiscoveryPageHTML() {
  return ui::ResourceBundle::GetSharedInstance().LoadDataResourceString(
      IDR_HONEYCOMB_DEVTOOLS_DISCOVERY_PAGE);
}

bool HoneycombDevToolsManagerDelegate::HasBundledFrontendResources() {
  return true;
}
