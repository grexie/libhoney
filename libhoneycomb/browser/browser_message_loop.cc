...
class MessagePumpExternal : public base::MessagePumpForUI {
 ...
 private:
  ...
  HoneycombRefPtr<HoneycombBrowserProcessHandler> handler_;
};

HoneycombRefPtr<HoneycombBrowserProcessHandler> GetBrowserProcessHandler() {
...
std::unique_ptr<base::MessagePump> MessagePumpFactoryForUI() {
  if (!content::BrowserThread::IsThreadInitialized(
    ...
    HoneycombRefPtr<HoneycombBrowserProcessHandler> handler = GetBrowserProcessHandler();
    if (handler) {
