...
#ifndef HONEYCOMB_LIBHONEYCOMB_COMMON_NET_URL_UTIL_H_
#define HONEYCOMB_LIBHONEYCOMB_COMMON_NET_URL_UTIL_H_
#pragma once
...
#endif  // HONEYCOMB_LIBHONEYCOMB_COMMON_NET_URL_UTIL_H_
