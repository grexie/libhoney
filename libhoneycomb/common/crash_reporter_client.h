...
#ifndef HONEYCOMB_LIBHONEYCOMB_COMMON_CRASH_REPORTER_CLIENT_H_
#define HONEYCOMB_LIBHONEYCOMB_COMMON_CRASH_REPORTER_CLIENT_H_
...
class HoneycombCrashReporterClient : public crash_reporter::CrashReporterClient {
 public:
  HoneycombCrashReporterClient();

  HoneycombCrashReporterClient(const HoneycombCrashReporterClient&) = delete;
  HoneycombCrashReporterClient& operator=(const HoneycombCrashReporterClient&) = delete;

  ~HoneycombCrashReporterClient() override;
  ...
  // called immediately after the HoneycombCrashReporterClient instance is created.
  ...
  // a process wide instance of HoneycombCrashReporterClient and initialize crash
 ...
 private:
  ...
  std::string product_name_ = "honey";
  std::string product_version_ = HONEYCOMB_VERSION;

#if BUILDFLAG(IS_WIN)
  std::string app_name_ = "Honeycomb";
...
#endif  // HONEYCOMB_LIBHONEYCOMB_COMMON_CRASH_REPORTER_CLIENT_H_
