...
#ifndef HONEYCOMB_LIBHONEYCOMB_COMMON_FRAME_UTIL_H_
#define HONEYCOMB_LIBHONEYCOMB_COMMON_FRAME_UTIL_H_
...
// Create a frame ID in the format exposed by the Honeycomb API.
...
#endif  // HONEYCOMB_LIBHONEYCOMB_COMMON_FRAME_UTIL_H_
