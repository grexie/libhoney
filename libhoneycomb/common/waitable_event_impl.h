...
#ifndef HONEYCOMB_LIBHONEYCOMB_COMMON_WAITABLE_EVENT_IMPL_H_
#define HONEYCOMB_LIBHONEYCOMB_COMMON_WAITABLE_EVENT_IMPL_H_
#pragma once
...
#endif  // HONEYCOMB_LIBHONEYCOMB_COMMON_WAITABLE_EVENT_IMPL_H_
