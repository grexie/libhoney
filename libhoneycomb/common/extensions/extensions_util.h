...
#ifndef HONEYCOMB_LIBHONEYCOMB_COMMON_EXTENSIONS_EXTENSIONS_UTIL_H_
#define HONEYCOMB_LIBHONEYCOMB_COMMON_EXTENSIONS_EXTENSIONS_UTIL_H_
...
#endif  // HONEYCOMB_LIBHONEYCOMB_COMMON_EXTENSIONS_EXTENSIONS_UTIL_H_
