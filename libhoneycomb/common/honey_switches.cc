...
// Enable use of the Chrome runtime in Honeycomb. See issue #2969 for details.
...
// Disable request handling in Honeycomb to faciliate debugging of network-related
// issues.
