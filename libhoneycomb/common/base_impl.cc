// Copyright 2014 The Honeycomb Authors. Portions copyright
...
constexpr const char kCategory[] = "honey.client";

}  // namespace

HONEYCOMB_EXPORT void honey_trace_event_instant(const char* /* category */,
                                        const char* name,
...
HONEYCOMB_EXPORT void honey_trace_event_begin(const char* /* category */,
                                      const char* name,
                                      const char* arg1_name,
                                      uint64_t arg1_val,
                                      const char* arg2_name,
...
HONEYCOMB_EXPORT void honey_trace_event_end(const char* /* category */,
                                    const char* name,
                                    const char* arg1_name,
                                    uint64_t arg1_val,
                                    const char* arg2_name,
...
HONEYCOMB_EXPORT void honey_trace_counter(const char* /* category */,
                                  const char* name,
...
HONEYCOMB_EXPORT void honey_trace_counter_id(const char* /* category */,
                                     const char* name,
                                     uint64_t id,
                                     const char* value1_name,
                                     uint64_t value1_val,
...
HONEYCOMB_EXPORT void honey_trace_event_async_begin(const char* /* category */,
                                            const char* name,
                                            uint64_t id,
                                            const char* arg1_name,
                                            uint64_t arg1_val,
...
HONEYCOMB_EXPORT void honey_trace_event_async_step_into(const char* /* category */,
                                                const char* name,
                                                uint64_t id,
                                                uint64_t step,
                                                const char* arg1_name,
...
HONEYCOMB_EXPORT void honey_trace_event_async_step_past(const char* /* category */,
                                                const char* name,
                                                uint64_t id,
                                                uint64_t step,
                                                const char* arg1_name,
...
HONEYCOMB_EXPORT void honey_trace_event_async_end(const char* /* category */,
                                          const char* name,
                                          uint64_t id,
                                          const char* arg1_name,
                                          uint64_t arg1_val,
...
HONEYCOMB_EXPORT int honey_get_min_log_level() {
  return logging::GetMinLogLevel();
}

HONEYCOMB_EXPORT int honey_get_vlog_level(const char* file_start, size_t N) {
  return logging::GetVlogLevelHelper(file_start, N);
}

HONEYCOMB_EXPORT void honey_log(const char* file,
                        int line,
                        int severity,
                        const char* message) {
...
HONEYCOMB_EXPORT honey_platform_thread_id_t honey_get_current_platform_thread_id() {
  return base::PlatformThread::CurrentId();
}

HONEYCOMB_EXPORT honey_platform_thread_handle_t
