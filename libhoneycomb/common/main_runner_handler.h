...
#ifndef HONEYCOMB_LIBHONEYCOMB_COMMON_MAIN_RUNNER_HANDLER_H_
#define HONEYCOMB_LIBHONEYCOMB_COMMON_MAIN_RUNNER_HANDLER_H_
#pragma once
...
#endif  // HONEYCOMB_LIBHONEYCOMB_COMMON_MAIN_RUNNER_HANDLER_H_
