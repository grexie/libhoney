...
#include "libhoneycomb/renderer/alloy/alloy_content_renderer_client.h"
...
#include "libhoneycomb/common/extensions/extensions_client.h"
...
#include "libhoneycomb/renderer/alloy/alloy_render_thread_observer.h"
#include "libhoneycomb/renderer/alloy/url_loader_throttle_provider_impl.h"
#include "libhoneycomb/renderer/browser_impl.h"
#include "libhoneycomb/renderer/extensions/extensions_renderer_client.h"
#include "libhoneycomb/renderer/extensions/print_render_frame_helper_delegate.h"
...
AlloyContentRendererClient::AlloyContentRendererClient()
  ...
  if (extensions::ExtensionsEnabled()) {
    extensions_client_.reset(new extensions::HoneycombExtensionsClient);
    extensions::ExtensionsClient::Set(extensions_client_.get());
    extensions_renderer_client_ =
        std::make_unique<extensions::HoneycombExtensionsRendererClient>(this);
...
AlloyContentRendererClient* AlloyContentRendererClient::Get() {
  ...
  return static_cast<AlloyContentRendererClient*>(
      HoneycombAppManager::Get()->GetContentClient()->renderer());
}
...
void AlloyContentRendererClient::PostIOThreadCreated(
  ...
  // TODO(honey): Enable these once the implementation supports it.
...
void AlloyContentRendererClient::RenderThreadStarted() {
  ...
  const bool is_extension = HoneycombRenderManager::IsExtensionProcess();
...
void AlloyContentRendererClient::RenderFrameCreated(
  ...
  auto render_frame_observer = new HoneycombRenderFrameObserver(render_frame);
  ...
  if (is_windowless.has_value()) {
    new printing::PrintRenderFrameHelper(
        render_frame,
        base::WrapUnique(
            new extensions::HoneycombPrintRenderFrameHelperDelegate(*is_windowless)));
  }
}
...
AlloyContentRendererClient::CreateURLLoaderThrottleProvider(
  ...
  return std::make_unique<HoneycombURLLoaderThrottleProviderImpl>(provider_type,
                                                            this);
}
