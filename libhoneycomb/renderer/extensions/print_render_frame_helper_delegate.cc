...
HoneycombPrintRenderFrameHelperDelegate::HoneycombPrintRenderFrameHelperDelegate(
    bool is_windowless)
...
blink::WebElement HoneycombPrintRenderFrameHelperDelegate::GetPdfElement(
...
bool HoneycombPrintRenderFrameHelperDelegate::IsPrintPreviewEnabled() {
  return !is_windowless_ && PrintPreviewEnabled();
}

bool HoneycombPrintRenderFrameHelperDelegate::ShouldGenerateTaggedPDF() {
  return true;
}

bool HoneycombPrintRenderFrameHelperDelegate::OverridePrint(
    blink::WebLocalFrame* frame) {
